<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="Manager_Dashboard_bk.aspx.cs" Inherits="UNO.Manager_Dashboard" %>
                        ...
                        <div class="DivSectionBelow">
                            <table width="100%" cellspacing="15">
                                <tr>
                                    <td colspan="2">
                                        <div class="ExcelDiv">
                                            <asp:TextBox ID="txtFromDate" Height="22px" runat="server" Width="26%"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtToDate" Height="22px" runat="server" Width="26%"></asp:TextBox>
