                    ...
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="ButtonControl" 
                                Style="float: right;" OnClientClick="return ResetAll();" 
                                 />
                            ...
                            <asp:TextBox ID="txtTimezoneId" MaxLength="12" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
...
" TargetControlID="txtTZDesc" />
    ...
    <asp:Panel ID="pnlEditTZ" runat="server" CssClass="PopupPanel" Style="display: block">
        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
                <table id="table6" runat="server" width="100%" height="118px" border="0" cellpadding="0"
                    cellspacing="0" class="TableClass">
                    <tr>
                        <td style="text-align: right;">
                            Timezone Code :<label class="CompulsaryLabel">*</label>
