<%@ Page Language="C#" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="BlacklistedVisitorsReport.aspx.cs" Inherits="UNO.BlacklistedVisitorsReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="heading" style='text-align: center; font-family: tahoma; font-size: x-large;'>
        Denial Visitors Report</h1>
    <div align="center">
        <asp:Panel runat="server" ID="HeadPanel">
            <table class="TableClass" style="width: 60%; height: 75px; margin-left: 4%; display: none;">
                <tr>
                    <td class="tdStyle">
                        <table width="100%">
                            <tr>
            ...
            <td style="text-align: right" class="style28" colspan="5">
                <div align="right" style="width: 93%;">
                    <asp:Button ID="btnClose" Text="Close" runat="server" CssClass="ButtonControl" Visible="False"
                        Width="90px" Height="23px" OnClientClick="navigateToUrl('Uno_Dashboard.aspx');return false;" />
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div align="center" style="width: 100%;">
                    <asp:Panel ID="viewer" runat="server" Height="350px" BorderStyle="Solid" BorderColor="#0066FF"
                        BorderWidth="3px" Width="87%" Visible="true">
