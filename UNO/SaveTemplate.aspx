    ...
    <script type="text/javascript">
        ...
        function Add() {
            ...
            else 
            {
                ...
                //var Check = document.getElementById('<%= rd2.ClientID %>').checked;
                var list = document.getElementById('<%= lstEmplyee.ClientID %>');
                if (Check == true) 
                {
                ...
                <ContentTemplate>
                    <div style="width: 100%; height: auto; margin-bottom: 30px; margin-top: 15px;">
                        ...
                        <div style="width: 100%; text-align: center;">
                            <input type="button" id="btnPrint" onclick="return Print();" value="Print Card" class="ButtonControl" onclick="return btnPrint_onclick()" />
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
