<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true" CodeBehind="rptEmployeeHistoryReport.aspx.cs" Inherits="UNO.rptEmployeeHistoryReport" %>
                    ...
                    <asp:Panel runat="server" ID="HeadPnl">
                        ...
                        <table class="TableClass" style="width: 100%; height: 75px; margin-left: 4%;">
                            <tr>
                                ...
                                <td style="display: none;width: 15%; height: 75px; text-align: left; border-right: lightsteelblue thin solid;
                                ...
                                <td style="display: none;width: 10%; height: 75px; text-align: left; border-right: lightsteelblue thin solid;
                                    border-top: lightsteelblue thin solid; border-left: lightsteelblue thin solid;
                                    border-bottom: lightsteelblue thin solid; font-weight: bold;">
