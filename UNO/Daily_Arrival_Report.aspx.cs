...
{
    public partial class Daily_Arrival_report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtCalendarFrom.Text = DateTime.Now.ToString("dd/MM/yyyy");
                ...
                View.Attributes.Add("onclick", "javascript:return ValidationReport('" + EmployeeHdn.ClientID + "','" + ComapnyHdn.ClientID + "','" + LocationHdn.ClientID + "','" + DivisionHdn.ClientID + "','" + DepartmentHdn.ClientID + "','" + ShiftHdn.ClientID + "','" + GroupHdn.ClientID + "','" + GradeHdn.ClientID + "','" + ListBox1.ClientID + "','" + ListBox2.ClientID + "','" + ListBox3.ClientID + "','" + ListBox4.ClientID + "','" + ListBox5.ClientID + "','" + ListBox6.ClientID + "','" + lstGroup.ClientID + "','" + RadioButtonList1.ClientID + "','" + RadioButtonList2.ClientID + "','" + RadioButtonList3.ClientID + "','" + RadioButtonList4.ClientID + "','" + RadioButtonList5.ClientID + "','" + RadioButtonList6.ClientID + "','" + rdbtnGroup.ClientID + "','" + txtCalendarFrom.ClientID + "');");

                if (Session["uid"].ToString().ToUpper() == "ADMIN")
                {                  
                    //fillEmplist();                    
                }
                else
        ...
        public void fillHiddenVal()
        {
            ...
            if (ShiftHdn.Value == "")
                ShiftHdn = a.empAllSelect(ListBox6);
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\Daily_Arrival.rdlc";
                viewer.Visible = true;
                ReportViewer1.Visible = true;
                ...
                cmd.CommandText = "usp_rpt_getDailArrivalDetails_wbsedcl";
                ...
                cmd.Parameters.AddWithValue("@strDate", txtCalendarFrom.Text);
                ...
                string strReportHeader = "Report generated on " + DateTime.Today.ToString("dd/MM/yyyy") + " at " + DateTime.Now.ToString("HH:mm") + " Hrs for " + strDate;
                ...
                ReportViewer1.LocalReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { para, address, header });
        ...
        {
            Response.Redirect("Daily_Arrival_Report.aspx");
        }
