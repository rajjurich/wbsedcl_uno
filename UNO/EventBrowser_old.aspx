<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="EventBrowser_old.aspx.cs" Inherits="UNO.EventBrowser" %>
    ...
    <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center" Width="100%">
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                <asp:Label ID="lblHead" runat="server" Text="Event Viewer" ForeColor="RoyalBlue" Font-Size="20px"
                        ...
                        <ContentTemplate>
                           ...
                           OnRowDataBound="gvEvent_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ReaderD" HeaderText="Reader" SortExpression="ReaderD">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CtrlD" HeaderText="Controller" SortExpression="CtrlD">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Event_Status" HeaderText="Status" SortExpression="Event_Status">
                                    </asp:BoundField>
