...
AutoEventWireup="True" CodeBehind="Visitor_Current_Strength.aspx.cs" Inherits="UNO.Visitor_Current_Strength" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table cellspacing="0" class="MenuTable">
    ...
    <h1 class="heading" style='text-align: center; font-family: tahoma; font-size: x-large;'>
        Visitor Current Strength Report
    </h1>
    <div align="center">
        ...
        <tr>
            <td colspan="5" align="right" style="height: 30px">
                <asp:Button ID="btnClose" Text="Close" runat="server" CssClass="ButtonControl" Visible="False"
                    Width="90px" Height="23px" OnClientClick="navigateToUrl('Visitor_Current_Strength.aspx');return false;" />
            </td>
        </tr>
        <tr>
            <td>
