...
namespace UNO
{
    public partial class Holiday_Attendance_Report : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\HolidayReport.rdlc";
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SAC_HOLIDAY_REPORT";
                ...
                cmd.Parameters.AddWithValue("@ENTITY", DivAsEntity);
                cmd.Parameters.AddWithValue("@GROUP", DeptAsGroup);
                cmd.Parameters.AddWithValue("@Division", GradeAsDiv);
                cmd.Parameters.AddWithValue("@Center", companyAsCenter);
                cmd.Parameters.AddWithValue("@Unit", locAsUnit);
                cmd.Parameters.AddWithValue("@Section", GroupAsSection);
                ...
                String dataSetName = "HolidayReport";
                String tableName = "Holiday_Report";//USER DEFINED NAME
                ...
                string Header = "Holiday Attendance Report";
                if (ddlPersonnelType.SelectedValue == "E")
                {
                    Header = "Employees Holiday Attendance Report";
                }
                else
                {
                    Header = "Non-Employees Holiday Attendance Report";
                }
                ...
                datasource.Value = thisDataSet.Tables[0];
        ...
        {
            Response.Redirect("Holiday_Attendance_Report.aspx");
        }
