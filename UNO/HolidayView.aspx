...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ResetCalendar() {
            document.getElementById('<%= calHolidayDateAdd.ClientID %>').SelectedDates.Clear();
            return false;
        }
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <asp:TextBox ID="txtHolidayID" MaxLength="10" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvHoliday" runat="server" AutoGenerateColumns="false" Width="100%"
                                        GridLines="None" AllowPaging="true" PageSize="10" OnRowCommand="gvHoliday_RowCommand"
                ...
                <table id="table2" runat="server" width="100%" border="0" cellpadding="0" cellspacing="5"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtHolidayIDAdd" runat="server" ClientIDMode="Static" CssClass="TextControl"
                                MaxLength="10" Style="text-transform: uppercase;" TabIndex="1"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtHolidayDateAdd" runat="server" CssClass="TextControl" ClientIDMode="Static"
                             onKeyPress="javascript: return false " TabIndex="4"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtSwapDateAdd" runat="server" CssClass="TextControl" ClientIDMode="Static"
                                onKeyPress="return KeyCheck(event)" TabIndex="5"></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="calSwapDateAdd" runat="server" TargetControlID="txtSwapDateAdd"
                                PopupButtonID="txtSwapDateAdd" Format="dd/MM/yyyy" Enabled="true">
                            </ajaxToolkit:CalendarExtender>
                     
                            <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="isValidateDDMMYYYYDate"
                                ControlToValidate="txtSwapDateAdd" Display="None" ErrorMessage="Please Enter Valid Date Or Keep It Blank"
                        ...
                        <td style="padding-left: 10px;">
                            <asp:RadioButtonList ID="chkSelectLocation" runat="server" RepeatDirection="Horizontal"
                                ClientIDMode="Static" AutoPostBack="false" TabIndex="6">
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <asp:Button ID="btnSubmitAdd" runat="server" CssClass="ButtonControl" TabIndex="7"
                                Text="Save" OnClick="btnSubmitAdd_Click" />
                            <asp:Button ID="btnCancelAdd" runat="server" CssClass="ButtonControl" TabIndex="8"
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                <table id="table1" runat="server" width="100%" border="0" cellpadding="0" cellspacing="5"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            ...
                            <ajaxToolkit:CalendarExtender ID="calSwapDateEdit" runat="server" TargetControlID="txtSwapDateEdit"
                                PopupButtonID="txtSwapDateEdit" Format="dd/MM/yyyy" Enabled="true">
                            </ajaxToolkit:CalendarExtender>

                            <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="isValidateDDMMYYYYDate"
                                ControlToValidate="txtSwapDateEdit" Display="None" ErrorMessage="Please Enter Valid Date Or Keep It Blank"
                                ForeColor="Red" SetFocusOnError="True"></asp:CustomValidator>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <asp:Button ID="btnSubmitEdit" runat="server" CssClass="ButtonControl" TabIndex="7"
                                Text="Save" OnClick="btnSubmitEdit_Click" />
                            <asp:Button ID="btnCancelEdit" runat="server" CssClass="ButtonControl" TabIndex="8"
