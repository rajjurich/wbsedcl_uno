...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkLength(el) {
           // debugger;
            var a = document.getElementById("txtRegisteredPinAdd");
            if (a.value.length != 0) {
                if (a.value.length != 6) {

                    document.getElementById("txtRegisteredPinAdd").focus();
                    //alert("length must be exactly 6 characters")

                    document.getElementById('<%=Label1.ClientID%>').style.display = "inline";
                    document.getElementById('<%=Label1.ClientID%>').innerHTML = "Pin Length Must Be Exactly 6 Digits";
        ...
        function checkLengthEdit(el) {
            debugger;
            var a = document.getElementById("txtRegisteredPinEdit");
            if (a.value.length != 0) {
                if (a.value.length != 6) {

                    document.getElementById("txtRegisteredPinEdit").focus();
                    //alert("length must be exactly 6 characters")

                    document.getElementById('<%=Label2.ClientID%>').style.display = "inline";
                    document.getElementById('<%=Label2.ClientID%>').innerHTML = "Pin Length Must Be Exactly 6 Digits";
                    return false;
                }
            }
            else {
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 50%; text-align: right;">
                                    ...
                                    <asp:TextBox ID="txtCompanyID" MaxLength="10" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 10px;">
                                    <asp:TextBox ID="txtCompanyIDAdd" runat="server" onkeypress="return IsAlphanumericWithoutspace(event)"
                                        CssClass="TextControl" MaxLength="10" TabIndex="1" Style="text-transform: uppercase;"
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 10px;">
                                    <asp:TextBox ID="txtRegisteredPinAdd" runat="server" onkeypress="return IsNumber(event)"
                                        CssClass="TextControl" MaxLength="6" TabIndex="5" Style="text-transform: capitalize;"
                                        ClientIDMode="Static" ValidationGroup="Add" onkeyup="cHK_CompAdd()"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">
                                    State :
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: center;">
                                        <asp:Button ID="btnSubmitAdd" runat="server" CssClass="ButtonControl" OnClick="btnSubmitAdd_Click"
                                            TabIndex="16" Text="Save" ValidationGroup="Add" OnClientClick="return checkLength(this);" />
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: center;">
                                        <asp:Button ID="btnSubmitEdit" runat="server" CssClass="ButtonControl" OnClick="btnSubmitEdit_Click"
                                            TabIndex="16" Text="Save" ValidationGroup="Edit" OnClientClick="return checkLengthEdit(this);" />
