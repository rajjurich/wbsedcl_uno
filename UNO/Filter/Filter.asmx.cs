...
namespace UNO.Filter
{
    ...
    public class Filter : System.Web.Services.WebService
    {
        ...
        public string FillEntitySpecificDetails(string strcom, string strloc, string strdiv, string strdept, string strcat, string strchecked, string strshift, string strSec, string strGRD, string strDesg)
        {

            SqlConnection con = new SqlConnection(m_connections);
            SqlDataAdapter da;
            DataTable dt = null;
            string strCompanyCode, strLocation, strDivision, strDepartment, strCategory, strShift, strSection, strGrade,strDesignation;
            ...
            strDesignation = HttpUtility.UrlDecode(strDesg) == "\'N\'" ? "N" : HttpUtility.UrlDecode(strDesg);
            try
            {
                ...
                cmd.CommandText = "USP_GET_EMPDETAILS_ROLEWISE_wbsedcl";
                ...
                cmd.Parameters.AddWithValue("@SelDesignationCode", strDesignation);
