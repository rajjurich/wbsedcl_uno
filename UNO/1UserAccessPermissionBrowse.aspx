...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FilterList() {
            ...
            for (i = 0; i <= list1.options.length - 1; i++) {
                lstall.push(list1.options[i].text);

                var string = list1.options[i].text.toLowerCase();
                var substring = strTxt.toLowerCase();
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ResetAll() {
            $('#' + ["<%=txtEntityName.ClientID%>", "<%=txt_empcode.ClientID%>", "<%=txtLevelDescription .ClientID%>"].join(', #')).prop('value', "");
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <ajaxToolkit:TextBoxWatermarkExtender ID="twetxtLevelDescription" runat="server"
                                TargetControlID="txtLevelDescription" WatermarkText="Level Description" WatermarkCssClass="watermark">
                            </ajaxToolkit:TextBoxWatermarkExtender>
                            <asp:TextBox ID="txt_empcode" runat="server" CssClass="searchTextBox" Style="float: right;"></asp:TextBox>
                            <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server"
                                TargetControlID="txt_empcode" WatermarkCssClass="watermark" WatermarkText="Employee Code">
                            </ajaxToolkit:TextBoxWatermarkExtender>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gvEmployeeAccess" runat="server" DataKeyNames="ID,AL_ID,ENTITY_TYPE"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ID" HeaderText="Employee Code" SortExpression="emp_code">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                                            ...
                                            <tr>
                                                <td style="width: 50%; text-align: left;" colspan="2">
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="twetxtAEntityDescAdd" runat="server" TargetControlID="txtAEntityDescAdd"
                                                        WatermarkText="Search by Field" WatermarkCssClass="watermark">
                                                    </ajaxToolkit:TextBoxWatermarkExtender>
                                                </td>
                ...
                <table style="width: 100%">
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <asp:Label ID="lblNote" runat="server" Text="If New added employee not visible in list please do the card configuration"
