...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onUpdated() {
            // get the update progress div
            var updateProgressDiv = $get('updateProgr                        essDiv');
            // make it invisible
...
//        }
        ...
        function Bio(EmpCode) { 
            try {
                ...
                var Return = WshShell.Run("C:/Perso/SignBio/NativeTemplate.exe " + EmpCode + " ISO Enrollment Bio", 1, true);
        ...
        var pin = "";
            ...
            try {
               ...
               $.ajax({
                ...
                //////////////////////////////////////////////////master card validation end


                //////////////////////////////////////////////////Cheking Connection with reader start
                var objReadCard;
                var DataInitialize;
                var cardCSNR = "";
                objReadCard = new ActiveXObject("ContactlessCardRW.Card");
                ...
                //////////////////////////////////////////////////Cheking Connection with reader end


                //////////////////////////////////////////////////Cheking Card getting connected Start
                var data;
                data = objReadCard.ConnectToCard();
                if (data != "") {
                    alert("Card not detected");
                ...
                //////////////////////////////////////////////////Cheking Card getting connected end


                //////////////////////////////////////////////////Cheking wheather that CSNR EXIST In the Inventory Start
                cardCSNR = objReadCard.CSNR.replace(/ /g, "").substring(0, 8);
                cardCSNR = ReverseCSNR(cardCSNR);
                var CSNRExist = false;
                $.ajax({
                ...
                //////////////////////////////////////////////////Cheking wheather that CSNR EXIST In the Inventory End



                //////////////////////////////////////////////////Authenticating Sector 2 blck 8 using CMSCalulatedKey Start
                ...
                //////////////////////////////////////////////////Authenticating Sector 2 blck 8 using CMSCalulatedKey End



                //////////////////////////////////////////////////Checking whether the card is alredy personalised or not(START)
                ...
                //////////////////////////////////////////////////Checking whether the card is alredy personalised or not(END)

                
                //////////////////////////////////////////////////Authenticating block by default key FFFFFFFFFF Sector 0 Block 1 (START)
                data = objReadCard.Authenticate(1, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 1");
                    $find("mpePersonaliseCard").hide();
                ...
                //////////////////////////////////////////////////Authenticating block by default key FFFFFFFFFF Sector 0 Block 1 (END)



                //////////////////////////////////////////////////Wrinting block by default data in  Sector 0 Block 1 (Start)
                WriteData = "";
                // WriteData = "FF0F0400000000000248000000000000";
                ...
                //////////////////////////////////////////////////Wrinting block by default data in  Sector 0 Block 1 (END)



                //////////////////////////////////////////////////Authenticating block by default key FFFFFFFFFF Sector 0 Block 2 (START)
                data = objReadCard.Authenticate(2, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 2");
                    $find("mpePersonaliseCard").hide();
                ...
                //////////////////////////////////////////////////Authenticating block by default key FFFFFFFFFF Sector 0 Block 2 (END)

              
                //////////////////////////////////////////////////Writing Some default data in Sector 0 Block 2 (START)
                WriteData = "";
                WriteData = "00000000000000000000010002000300";
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.WriteData(WriteData, "2");
                ...
                //////////////////////////////////////////////////Writing Some default data in Sector 0 Block 2 (END)



                //////////////////////////////////////////////////Authenticating  Sector 0 Block 3 by default key FFFFFFFFFF(START)
                data = objReadCard.Authenticate(3, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 3");
                ...
                //////////////////////////////////////////////////Authenticating  Sector 0 Block 3 by default key FFFFFFFFFF(END)

               //////////////////////////////////////////////////Writing CMS KEy,access condition,default key in Sector 0 Block 2 (START)
                WriteData = "";
                WriteData = CMSCalulatedKey + "FF078069" + "FFFFFFFFFFFF";
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.WriteData(WriteData, "3");
                ...
                //////////////////////////////////////////////////Writing CMS KEy,access condition,default key in Sector 0 Block 2 (END)
                                                   // ***********Sector 0 End ************* //

                                                 // ***********Sector 1 Start ************** //
                //////////////////////////////////////////////////Storing Employee Name in WriteData(START)
                var EmpName = document.getElementById("<%= txtEmployeeName.ClientID %>").value.rpad(" ", 32);
                var WriteData = "";
                WriteData = EmpName.substr(0, 16);
                //////////////////////////////////////////////////Storing Employee Name in WriteData(END)


                //////////////////////////////////////////////////Authenticating  Sector 1 Block 4 by default key FFFFFFFFFF(START)
                data = objReadCard.Authenticate(4, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 4");
                    $find("mpePersonaliseCard").hide();
                ...
                //////////////////////////////////////////////////Authenticating  Sector 1 Block 4 by default key FFFFFFFFFF(END)


                //////////////////////////////////////////////////Writing EMPLOYEE Name in Sector 1 Block 4 (START)
                data = objReadCard.WriteData(WriteData, "04");
                if (data != "") {
                    alert("Card Error: Unable to write in the card.Sector 1 Block 4");
                    $find("mpePersonaliseCard").hide();
                ...
                //////////////////////////////////////////////////Writing EMPLOYEE Name in Sector 1 Block 4 (END)


                //////////////////////////////////////////////////Authenticating & Writing EMPLOYEE Name in Sector 1 Block 5 (START)
                WriteData = EmpName.substr(16, 32);
                data = objReadCard.Authenticate(5, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 5");
                ...
                //////////////////////////////////////////////////Authenticating & Writing EMPLOYEE Name in Sector 1 Block 5 (END)


                //////////////////////////////////////////////////Capturing data like DOB,DOE,Gender (START)
                var DOB = document.getElementById("<%= txtDOB.ClientID %>").value;
                var DOE = document.getElementById("<%= txtCardExpiryDate.ClientID %>").value;
                var ExpiryTime = document.getElementById("<%= txtCardExpiryTime.ClientID %>").value;
                DOB = DOB.replace(/\//g, "");
                ...
                //////////////////////////////////////////////////Capturing data like DOB,DOE,Gender (END)



                //////////////////////////////////////////////////Authenticating & Writing EMPLOYEE Name in Sector 1 Block 6 (START)
                WriteData = "";
                //WriteData = DOB + Gender + "FFFFFFFFFFFFFFFFFFFFFF";
                WriteData = DOB + Gender + DOE + ExpiryTime + "0000000000";
                WriteData = objReadCard.Convert(WriteData);
                ...
                //////////////////////////////////////////////////Authenticating & Writing EMPLOYEE Name in Sector 1 Block 6 (END)

                //////////////////////////////////////////////////Authenticating & Writing CMSCalulatedKey,Access Condition,Deafult Key in Sector 1 Block 7 (START)
                WriteData = "";
                data = objReadCard.Authenticate(7, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 7");
                ...
                //////////////////////////////////////////////////Authenticating & Writing CMSCalulatedKey,Access Condition,Deafult Key in Sector 1 Block 7 (END)
               ...
               // var EmployeeCode2 = document.getElementById("<%= txtEmployeeCode.ClientID %>").value.lpad("0", 8);
                ...
                WriteData = PadBytes(WriteData, 32);
                //////////////////////////////////////////////////Capturing Employee Code(END)


                //////////////////Authenticating & Writing Employee Code in Sector 2 Block 8(START)
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.Authenticate(8, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 8");
                ...
                //////////////////Authenticating & Writing Employee Code in Sector 2 Block 8(END)


                //////////////////////////////////////////////////Capturing DOE2,ExpiryTime2,DOE2 (START)
                var DOE2 = document.getElementById("<%= txtCardExpiryDate.ClientID %>").value;
                var ExpiryTime2 = document.getElementById("<%= txtCardExpiryTime.ClientID %>").value;
                DOE2 = DOE2.replace(/\//g, "");
                ExpiryTime2 = ExpiryTime2.replace(/:/g, "");
                WriteData = "";
                WriteData = DOE2 + ExpiryTime2 + "00" + "00" + "00" + "00000000000000";
                //////////////////////////////////////////////////Capturing DOE2,ExpiryTime2,DOE2 (END)


                //////////////////Authenticating & Writing DOE2,ExpiryTime2,DOE2 in Sector 2 Block 9(START)
                WriteData = PadBytes(WriteData, 32);
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.Authenticate(9, "FFFFFFFFFFFF", 96);
                if (data != "") {
                ...
                //////////////////Authenticating & Writing DOE2,ExpiryTime2,DOE2 in Sector 2 Block 9(END)


                //////////////////Authenticating & Writing CalculateCMSKeyWithRandomNo in Sector 2 Block 11(START)
                WriteData = "";
                data = objReadCard.Authenticate(11, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 11");
                ...
                //////////////////Authenticating & Writing CalculateCMSKeyWithRandomNo in Sector 2 Block 11(END)
                                            // *********** Sector 2 End**************** //
                ...
                ///Caturing EmployeeCode(END)

                //////////////////Authenticating & Writing EmployeeCode,PS,PIN,RFU in Sector 3 Block 12(START)
                WriteData = "";
              //  WriteData = ConvertStringToHex(EmployeeCode3) + "00" + "01010101" + "00";
                ...
                //////////////////Authenticating & Writing EmployeeCode,PS,PIN,RFU in Sector 3 Block 12(END)


                ///Caturing DOE3,ExpiryTime3 etc (START)
                var DOE3 = document.getElementById("<%= txtCardExpiryDate.ClientID %>").value;
                var ExpiryTime3 = document.getElementById("<%= txtCardExpiryTime.ClientID %>").value;
                DOE3 = DOE3.replace(/\//g, "");
                ExpiryTime3 = ExpiryTime3.replace(/:/g, "");
                WriteData = "";
                WriteData = DOE3 + ExpiryTime3 + "00" + "00" + "00" + "000000" + "00" + "00" + "00" + "00";
                ///Caturing DOE3,ExpiryTime3 etc  (END)


                //////////////////Authenticating & Writing  DOE3,ExpiryTime3 in Sector 3 Block 13(START)
                WriteData = PadBytes(WriteData, 32);
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.Authenticate(13, "FFFFFFFFFFFF", 96);
                if (data != "") {
                ...
                //////////////////Authenticating & Writing CalculateCMSKeyWithRandomNo in Sector 3 Block 15(START)
                WriteData = "";
                data = objReadCard.Authenticate(15, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 15");
                ...
                //////////////////Authenticating & Writing Master KEY  in Sector 13 Block 55(START)
                ...
                //////////////////Authenticating & Writing Master KEY  in Sector 13 Block 55(END)

                                                 // *****Sector 13 End ********//

                                                 // ******Sector 14 Start ********//

                //////////////////Authenticating & Writing RandomNumber in Sector 14 Block 56(START)
                ...
                //////////////////Authenticating & Writing RandomNumber  in Sector 14 Block 56(END)

                //////////////////Authenticating & Writing Master KEY  in Sector 14 Block 59(START)
                WriteData = MasterKey + "FF078069" + MasterKey;
                ...
                //////////////////Authenticating & Writing Master KEY  in Sector 14 Block 59(END)
                ...
                //////////////////Capturing Company Code(CC),SiteID15,DOE15,ExpiryTime15,DOE15,ExpiryTime15,CheckSum15 (START)
                var CompanyCode15 = CompCode;
                var SiteID15 = "00";
                var DOE15 = document.getElementById("<%= txtCardExpiryDate.ClientID %>").value;
                var ExpiryTime15 = document.getElementById("<%= txtCardExpiryTime.ClientID %>").value;
                ...
                ExpiryTime15 = ExpiryTime15.replace(/:/g, "");
                var CheckSum15 = "78";
                //////////////////Capturing Company Code(CC),SiteID15,DOE15,ExpiryTime15,DOE15,ExpiryTime15,CheckSum15(END)

                //////////////////Authenticating & Writing Company Code(CC),SiteID15,DOE15,ExpiryTime15,DOE15,ExpiryTime15,CheckSum15  in Sector 15 Block 60(START)
                WriteData = "";
                WriteData = PadBytes(CompanyCode15 + SiteID15 + "00" + "0000" + DOE15 + ExpiryTime15 + CheckSum15 + "0000" + "00", 32);
                WriteData = objReadCard.Convert(WriteData);
                data = objReadCard.Authenticate(60, "FFFFFFFFFFFF", 96);
                ...
                //////////////////Authenticating & Writing Company Code(CC),SiteID15,DOE15,ExpiryTime15,DOE15,ExpiryTime15,CheckSum15  in Sector 15 Block 60(END)


                //////////////////Authenticating & Writing CMSCalulatedKey in Sector 15 Block 63(START)
                WriteData = "";
                data = objReadCard.Authenticate(63, "FFFFFFFFFFFF", 96);
                if (data != "") {
                    alert("Unable to Authenticate Block 63");
                ...
                //////////////////Authenticating & Writing CMSCalulatedKey  in Sector 15 Block 63(END)

                                        // **************Sector 15 End ***************//

                ///////////////////////After Personalisation Saving Details in DATABASE(START)
                ...
                ///////////////////////After Personalisation Saving Details in DATABASE(END)
                alert("Card personalised Successfully.");
