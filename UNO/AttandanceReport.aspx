<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="AttandanceReport.aspx.cs" Inherits="UNO.AttandanceReport" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OnShow(action) {
            if (ValidateData()) {
                ...
                var url = "AttandanceReport.aspx?" + sBody;
                formName.action = url;
                formName.submit();
            }
        }
        ...
        function HandleAction(formAction, recomputeParentControlName) {
            ...
            httpRequest.open('POST', 'AttandanceReport.aspx', true);
