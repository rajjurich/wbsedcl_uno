...
namespace UNO
{
    public partial class EmpAndNonEmpStrength : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\Emp_AndNon_Emp_Strength.rdlc";
                viewer.Visible = true;
                ReportViewer1.Visible = true;
                ...
                cmd.CommandText = "SAC_Emp_AndNon_Emp_Strength_Report";
                ...
                String dataSetName = "EmpAndNonEmpReport";
                ...
                {
                    Header = "Employees Strength Report";
                }
                else
                {
                    Header = "Non-Employees Strength Report";
                }
                lblHeader.Text = Header;
                DataTable dt = GroupBy("Employee", "Employee", dtData);
                string strEmpCount = "0";

                if (dt.Rows.Count > 0)
                    strEmpCount = dt.Rows[0]["Count"].ToString();

                ReportParameter empTotal = new ReportParameter("EmpCount", strEmpCount);
                ...
                ReportViewer1.LocalReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { para, empTotal, rpHeader, header, address });
        ...
        {
            Response.Redirect("EmpAndNonEmpStrength.aspx");
        }
