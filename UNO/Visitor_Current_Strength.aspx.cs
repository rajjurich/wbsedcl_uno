...
namespace UNO
{
    public partial class Visitor_Current_Strength : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\Visitor_Current_Strength.rdlc";
                ReportViewer1.Visible = true;
                ...
                SqlCommand cmd = new SqlCommand("exec USP_rpt_GetVisitorsDetails @RptType='Current_Strength',@dtFromDate='" + FromDate + "',@dtToDate='" + ToDate + "'", conn);
