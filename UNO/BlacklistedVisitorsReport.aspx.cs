...
namespace UNO
{
    public partial class BlacklistedVisitorsReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\Blacklisted Visitor.rdlc";
                ReportViewer1.Visible = true;
                ...
                da = new SqlDataAdapter("exec USP_rpt_GetVisitorsDetails @RptType='Denied',@dtFromDate='" + FromDate + "',@dtToDate='" + ToDate + "'", m_connectons);
                da.Fill(dtData);

                //OPEN RDLC,GO TO REPORT MENU ->DATASOURCES ,CHECK NAME OF DATASOURCE USED IN THIS RDLC,
                String dataSetName = "dtDeniedVisitors";
