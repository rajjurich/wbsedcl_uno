                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <asp:TextBox ID="textreasonid" MaxLength="10" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
            ...
            <ContentTemplate>
                <table id="table8" runat="server" border="0" cellpadding="0" cellspacing="0" class="TableClass" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="TDClassControl" >
                            <asp:TextBox CssClass="TextControl" ID="txtReason_ID" MaxLength="10" runat="server"
