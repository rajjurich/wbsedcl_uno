...
namespace UNO
{
    public partial class rptEmployeeHistoryReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\Employee_History.rdlc";
                viewer.Visible = true;
                ReportViewer1.Visible = true;
                ...
                cmd.CommandText = "usp_rpt_getEmployeeHistoryDetails";
        ...
        {
            Response.Redirect("rptEmployeeHistoryReport.aspx");
        }
