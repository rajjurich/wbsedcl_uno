    ...
    public partial class ESS_TA_LV_View : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    IEnumerable<DataRow> drRow = (from acs in dt.AsEnumerable()
                                                  join comwise in thisDataSet.AsEnumerable() on acs.Field<string>("ess_LA_empid") equals comwise.Field<string>("EOD_EMPID")
                                                  select acs
                                 );
        ...
        public void fillModifydata(string rowid)
        {
            try
            {
                ...
                WriteLog("1 From Date from DB :-" + dt.Rows[0]["FromDate"].ToString());
                WriteLog("1 To Date fromm DB :-" + dt.Rows[0]["ToDate"].ToString());
        ...
        public void ModifyLeaveApplication()
        {
            ...
            WriteLog(" Edit 1 From Date :-" + strdbFrmdt);
            WriteLog(" Edit 1 To Date :-" + strdbToDt);
            ...
            DateTime dtfromdt = CMSDateTime.CMSDateTime.ConvertToDateTime(strdbFrmdt, "dd/MM/yyyy");
            DateTime dtttodt = CMSDateTime.CMSDateTime.ConvertToDateTime(strdbToDt, "dd/MM/yyyy");

            WriteLog(" Edit Datetime 2 From Date :-" + dtfromdt);
            WriteLog(" Edit Datetime 2 To Date :-" + dtttodt);
            ...
            try
            {
                ...
                WriteLog("ALl Leave Condition Clear");
                ...
                cmdLvRule.Parameters.AddWithValue("@pLeaveFromDate", CMSDateTime.CMSDateTime.ConvertToDateTime(strdbFrmdt, "dd/MM/yyyy"));
                cmdLvRule.Parameters.AddWithValue("@pLeaveToDate", CMSDateTime.CMSDateTime.ConvertToDateTime(strdbToDt, "dd/MM/yyyy"));

                WriteLog("Proc Value :-" + strdbFrmdt);
                WriteLog("Proc Value :-" + strdbToDt);
