...
CodeBehind="SACCapturePersoDetails_Idea.aspx.cs" Inherits="UNO.SACCapturePersoDetails_Idea" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvEmpDetails" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Employee Name" HeaderStyle-CssClass="display" ItemStyle-CssClass="display">
                                            <ItemTemplate>
