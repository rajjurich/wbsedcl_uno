    ...
    public partial class ShiftScheduleCorrection : System.Web.UI.Page
    {
        ...
        protected void OnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@pFromDate", CMSDateTime.CMSDateTime.ConvertToDateTime(txtFromDateSC.Text, "dd/MM/yyyy"));
                cmd.Parameters.AddWithValue("@pToDate", CMSDateTime.CMSDateTime.ConvertToDateTime(txtToDateSC.Text, "dd/MM/yyyy"));
