...
namespace UNO
{
    public partial class VEH_VehicleDenialReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "RDLC\\VEH_VehicleDenialReport.rdlc";
                ReportViewer1.Visible = true;


                String commandText = "SELECT * FROM [dbo].[veh_vehicleEntries] where staus='DENIED'";
