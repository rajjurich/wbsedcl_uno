<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="SACViewCard_bkup.aspx.cs" Inherits="UNO.SACViewCard" %>
      ...
      116, 42, 200, 150, 21, 75, 169, 247, 182, 232, 10, 84, 215, 137, 107, 53];
        ...
        function ViewCard() {
            ...
            //   var key3 = objReadCard.CalculatetApplKey(parseInt(ReadData), RandomNo, Key_a_Buf);
              ...
              EmployeeCode = EmployeeCode.substr(0, 20);
                var empcode = "";
                var j = 1;
                ...
                data = objReadCard.ReadBlock(12).replace(/ /g, "");
    ...
    <asp:Panel ID="pnlViewCard" runat="server" Style="width: 100%; text-align: center;">
        <table style="margin: 0 auto;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEmployeeCode" runat="server" MaxLength="10" ReadOnly="true"
                        ValidationGroup="ModifyCard" Enabled="False"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEmployeeName" runat="server" ValidationGroup="ModifyCard" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDOB" runat="server" ValidationGroup="ModifyCard" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtExpiryDate" runat="server" ValidationGroup="ModifyCard" 
                        ReadOnly="true" Enabled="False"></asp:TextBox>
               ...
               <tr>
                                            ...
                                            <td style="text-align: left;">
                                                <asp:TextBox ID="txtCardExpiryTime" runat="server" CssClass="TextControl" MaxLength="5"
                                                    ...
                                                    TabIndex="2" ValidationGroup="CardPerso" ReadOnly="true" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
            ...
            <tr style="display:none;">
                ...
                <td>
                    <asp:DropDownList ID="ddlEmployeeType" runat="server" 
                        ValidationGroup="ModifyCard" Enabled="False">
