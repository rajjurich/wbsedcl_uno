    ...
    public partial class LeaveAppEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                calLeaveFrDt.EndDate = DateTime.Now.Date;
                CalLeaveTodt.EndDate = DateTime.Now.Date;
        ...
        public void UpdateLeaveData()
        {
            ...
            DateTime dtfromdt = CMSDateTime.CMSDateTime.ConvertToDateTime(txtLeaveFrDt.Text, "dd/MM/yyyy");
            DateTime dtttodt = CMSDateTime.CMSDateTime.ConvertToDateTime(TxtLeaveTodt.Text, "dd/MM/yyyy");
            ...
            try
            {
                ...
                */
                   ...
                   objcmd.Parameters.AddWithValue("@leaveFromdate", CMSDateTime.CMSDateTime.ConvertToDateTime(txtLeaveFrDt.Text, "dd/MM/yyyy"));
                   objcmd.Parameters.AddWithValue("@leaveTodate", CMSDateTime.CMSDateTime.ConvertToDateTime(TxtLeaveTodt.Text, "dd/MM/yyyy"));
