<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="ManualAttendView.aspx.cs" Inherits="UNO.ManualAttendView" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvManualAttnd" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ClientIDMode="Static" GridLines="None" AllowPaging="true" 
                                    PageSize="10" OnDataBound="gvManualAttnd_DataBound" 
                                    onrowediting="gvManualAttnd_RowEditing">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ShowHeader="False" SortExpression="Edit" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="true" CommandName="Edit"
                                            ...
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId" runat="server" Text='<%#Eval("MA_RECID")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="MA_EMPID" HeaderText="Employee Code" SortExpression="Employee Code">
