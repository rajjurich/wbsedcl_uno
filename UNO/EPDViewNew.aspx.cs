    ...
    public partial class EPDViewNew : System.Web.UI.Page
    {
        ...
        public void FillDropDowns()
        {
            ...
            if (Session["uid"].ToString().ToLower() != "admin")
            {
                ...
                ddlcompany.DataSource = ds.Tables[9];
                ddlcompany.DataBind();
        ...
        void bindDataGrid()
        {
            try
            {
                ...
                DataTable dt = clsEmployeeHandler.GetEmployeeManagerDetails(ddlEmpStatus.SelectedValue.ToString(), "AllEmployees", "",Session["levelId"].ToString());
        ...
        protected void Modify_Data(string Employeeid)
        {
            ...
            try
            {
                ...
                ddlcompany_SelectedIndexChanged(ddlcompany.SelectedValue,null);
                ...
                if (dtAllData.Rows[0]["EOD_ACTIVE"].ToString() != "")
                {
                    ...
                    {
                        if (Convert.ToString(dtAllData.Rows[0]["essenabled"]) == "1" && dtAllData.Rows[0]["EOD_ACTIVE"].ToString() == "True")
        ...
        protected void btnAddE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string empid = EPD_EMPLOYEEID.Text.Trim().ToUpper();

                    string Zeros = new string('0', 10 - empid.Length);
                    empid = Zeros + empid;
                   // Session["empid"] = empid;
        ...
        private void InsertOrUpdate(string strCommand, ref string ErrMsg, ref string strSucMsg)
        {
            ...
            objEmp.EMPLOYEEID = EPD_EMPLOYEEID.Text.Trim().ToUpper(); //Session["empid"].ToString();  //EPD_EMPLOYEEID.Text.Trim().ToUpper();
            ...
            objEmp.PreviousId = EPD_PREVIOUS_CODE.Text.Trim();
            objEmp.cardID = EPD_CARD_NO.Text.Trim().ToUpper();
        ...
        protected void EPD_EMPLOYEEID_TextChanged(object sender, EventArgs e)
        {
        }

        protected void ddlcompany_SelectedIndexChanged(object sender, EventArgs e)
        {
            DataSet ds = clsCommonHandler.GetCommonTableDetails("CompanyFlag",ddlcompany.SelectedValue);
