...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <asp:TextBox ID="txtID" runat="server" MaxLength="10" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>                          
    ...
    <asp:Panel ID="pnlAddAccessLevel" runat="server" CssClass="PopupPanel" style="width:100%" >
                ...
                <table id="table2" runat="server" border="0" cellpadding="0" cellspacing="5" class="TableClass">
                    <tr>
                        ...
                        <td style="padding-left: 10px;" class="style38">
                            <asp:TextBox CssClass="TextControl" ID="txtalidAdd" MaxLength="10" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;" class="style38">
                            <asp:ListBox ID="lstAReaderAdd" runat="server" Height="90px" Width="500px" ForeColor="Black"
                        ...
                        <td style="padding-left: 10px;">
                            <asp:ListBox ID="lstSReaderAdd" runat="server" Height="90px" Width="500px" ForeColor="Black"
                                Font-Names="Courier New" CssClass="TextControl" ClientIDMode="Static" SelectionMode="Multiple"
    ...
    <asp:Panel ID="pnlEditAccessLevel" runat="server" CssClass="PopupPanel" style="width:100%">
            ...
            <ContentTemplate>
                <table id="table1" runat="server" border="0" cellpadding="0" cellspacing="5" class="TableClass">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;" class="style37">
                            <asp:ListBox ID="lstAReaderEdit" Visible="true" runat="server" Height="90px" Width="500px"
                        ...
                        <td style="padding-left: 10px;">
                            <asp:ListBox ID="lstSReaderEdit" runat="server" Height="90px" Width="500px" ForeColor="Black"
                                Font-Names="Courier New" CssClass="TextControl" ClientIDMode="Static" SelectionMode="Multiple"
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <asp:Button ID="btnAccessLevelEdit" runat="server" CssClass="ButtonControl" Text="Save"
                                TabIndex="9" ValidationGroup="Edit" OnClick="btnAccessLevelEdit_Click" OnClientClick="this.disabled = true; this.value = 'Submit in progress...';" UseSubmitBehavior="false" />
