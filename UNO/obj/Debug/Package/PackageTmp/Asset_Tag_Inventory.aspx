...
<script language="javascript" type="text/javascript" src="Scripts/Validation.js"></script>
    <script type="text/javascript">
        ...
        function Validate() {
            var firstInput = document.getElementById('<%=txtFromTag.ClientID %>').value;
            var secondInput = document.getElementById('<%=txtToTag.ClientID %>').value;
            var Message = document.getElementById('<%=lblPnlNew.ClientID %>');
            if (firstInput > secondInput) {
                Message.innerHTML = "To Tag Number should be Greater than Or Equal to From Tag Number"
                return false;
                                ...
                                <table id="FromToTag" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <%--  <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="To Tag Number should be Greater than Or Equal to From Tag Number"
                                             ControlToValidate="txtToTag" ControlToCompare="txtFromTag" Type="Integer" Operator="GreaterThan" ValidationGroup="Add"
                                             Display="None" >
                                    ...
                                    <tr>
                                        <td colspan="4" style="text-align: center">
                                            <asp:Button ID="btnSaveTags" runat="server" class="ButtonControl" Text="Save" ValidationGroup="Add"
                                                OnClick="btnSaveTags_Click" OnClientClick="return Validate();" />
