<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false"
    CodeBehind="EmployeeCardConfigureADD.aspx.cs" Inherits="UNO.EmployeeCardConfigureADD" Culture="en-GB" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ChkServerSideValidation() {
            ...
            if (document.getElementById('<%=txtMinimumSwipe.ClientID%>').value == '') {
                document.getElementById('<%=lblMsg.ClientID%>').innerHTML = 'Please enter use count';
                return false;
            }
            else if (document.getElementById('<%=Pin.ClientID%>').value == '') {
                document.getElementById('<%=lblMsg.ClientID%>').innerHTML = 'Please Enter PIN here';
                return false;
            }
            else if (document.getElementById('<%=Act_Date.ClientID%>').value == '') {
                document.getElementById('<%=lblMsg.ClientID%>').innerHTML = 'Please enter activation date';
                return false;
            }
            else if (document.getElementById('<%=Exp_Date1.ClientID%>').value == '') {
                document.getElementById('<%=lblMsg.ClientID%>').innerHTML = 'Please enter expiry date';
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
        <table width="100%">
            <tr>
                <td>
                    <asp:Label ID="lblHederText" runat="server" Text="Employee Card Config Master" CssClass="heading"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="CmdOk" runat="server" CssClass="ButtonControl" Text="Save" TabIndex="8"
                    OnClick="CmdOk_Click" OnClientClick="return ValidateSave();" ValidationGroup="Date" />
