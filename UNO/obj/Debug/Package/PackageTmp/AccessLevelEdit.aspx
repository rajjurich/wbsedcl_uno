<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="AccessLevelEdit.aspx.cs" Inherits="UNO.AccessLevelEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function returnviewmode() {
            ...
            window.location = "AccessLevelBrowse.aspx";
        }
            ...
            <table id="table2" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <table>
                            <tr>
                                <td class="TDClassControl">
                                    <asp:TextBox CssClass="TextControl" ID="txtalid" MaxLength="15" runat="server" Style="text-transform: uppercase;"
                                        Width="174px" ClientIDMode="Static" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td class="style20">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtalid"
                                        ErrorMessage="Access level id is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                    <br>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtalid"
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" valign="top" class="TDClassControl">
                                    <asp:RadioButtonList ID="RBLZone" runat="server" CssClass="ComboControl" Width="100%"
                                        OnSelectedIndexChanged="RBLZone_SelectedIndexChanged" AutoPostBack="True" Height="50px"
                                        TabIndex="2">
                                ...
                                <td align="left" valign="top">
                                    <asp:Panel ID="PnlZone" runat="server" HorizontalAlign="Left" Width="174px">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="TDClassControl">
                                                    <asp:DropDownList ID="cmbZone" runat="server" Width="108px" AutoPostBack="True" OnSelectedIndexChanged="cmbZone_SelectedIndexChanged"
                                                        TabIndex="3">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                ...
                <tr>
                    ...
                    <td class="TDClassControl" style="height: 10px">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cmbTimeZone"
	...
	<td class = "UAPTDClassLabel" style="height: 10px"> 
        <asp:Button ID="CmdOk" runat="server" Text="Save" CssClass="ButtonControl" onclick="CmdOk_Click" 
            />
        </td>
	<td class = "TDClassControl" style="height: 10px">
