                    ...
                    <table style="width: 100%;" border="0">
                        <tr>
                            ...
                            <td style="width: 60%; text-align: right; color: Black;">
                                ...
                                <asp:TextBox ID="txtCompanyName" runat="server" Style="float: right;" CssClass="searchTextBox" OnTextChanged="txtCompanyName_TextChanged"></asp:TextBox>
                                <ajaxToolkit:TextBoxWatermarkExtender ID="twetxtCompanyName" runat="server" TargetControlID="txtCompanyName"
                                    WatermarkText="Employee Name" WatermarkCssClass="watermark" BehaviorID="CompanyNameWatermark">
                                </ajaxToolkit:TextBoxWatermarkExtender>
                                <asp:TextBox ID="txtCompanyID" runat="server" MaxLength="10" Style="float: right;"
                                ...
                                <ajaxToolkit:TextBoxWatermarkExtender ID="twetxtCompanyID" runat="server" TargetControlID="txtCompanyID"
                                    WatermarkText="Employee ID" WatermarkCssClass="watermark" BehaviorID="CompanyIDWatermark">
                                </ajaxToolkit:TextBoxWatermarkExtender>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <table id="table2" runat="server" width="100%" height="90%" border="0" cellpadding="0"
                                ...
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td style="height: 10px; width: 100px;" class="TDClassControl1" runat="server">
                                        <asp:TextBox CssClass="TextControl" ID="EPD_EMPLOYEEID" MaxLength="10" runat="server"
                                            Style="text-transform: uppercase;" TabIndex="1" ClientIDMode="Static" 
                                ...
                                <tr id="Tr5" runat="server">
                                    ...
                                    <td id="Td6" style="height: 10px; width: 100px;" runat="server" class="TDClassControl1">
                                        <asp:TextBox ID="EPD_SALUTATION" runat="server" CssClass="TextControl" MaxLength="10"
                                ...
                                <tr id="Tr6" runat="server">
                                    ...
                                    <td id="Td48" style="height: 10px; width: 100px;" runat="server" class="TDClassControl1">
                                            ...
                                            <asp:DropDownList CssClass="TextControl" ID="EPD_BLOODGROUP" runat="server"
                                            Style="text-transform: capitalize;" TabIndex="20" Width="80px">
                                    ...
                                    <fieldset>
                                            ...
                                            <tr runat="server">
                                                ...
                                                <td style="height: 10px;" runat="server" rowspan="2" class="TDClassControl1">
                                                    <asp:TextBox ID="EAD_ADDRESS1" runat="server" CssClass="TextControl" Height="40px"
                                                        ...
                                                        TabIndex="23" onkeyup="addressSubmit()" onkeypress="maximumLimit(this, 149);"
                                            ...
                                            <tr runat="server">
                                                ...
                                                <td id="Td30" style="height: 10px" runat="server" class="TDClassControl1">
                                                    <asp:TextBox ID="EAD_Phone1" onkeypress="return IsNumber(event)" runat="server" CssClass="TextControl"
                                                        MaxLength="15" Style="text-transform: capitalize;" ClientIDMode="Static" TabIndex="27"
                                                        Width="80px" onkeyup="phno1Submit()" ValidationGroup="validateofficial"></asp:TextBox>
                                                    <asp:RangeValidator runat="server" ID="RV_EAD_Phone1" ControlToValidate="EAD_Phone1"
                                                        Display="None" ValidationGroup="validateofficial" Type="Double" SetFocusOnError="true"
                                                        MinimumValue="1000000000" MaximumValue="999999999999999" ErrorMessage="Please Insert Minimum 10 and Maximum 15 Digits Required" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender24" runat="server"
                                                        PopupPosition="Right" TargetControlID="RV_EAD_Phone1">
                                                    </ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                                ...
                                                <td id="Td38" style="height: 10px" runat="server" class="TDClassControl1">
                                                    <asp:TextBox ID="EAD_Phone2" runat="server" ClientIDMode="Static" CssClass="TextControl"
                                                        MaxLength="15" onkeyup="phno2Submit()" onkeypress="return IsNumber(event)" Style="text-transform: capitalize;"
                                                        TabIndex="28" Width="80px" ValidationGroup="validateofficial"></asp:TextBox>
                                                    <asp:RangeValidator runat="server" ID="RV_EAD_Phone2" ControlToValidate="EAD_Phone2"
                                                        Display="None" ValidationGroup="validateofficial" Type="Double" SetFocusOnError="true"
                                                        MinimumValue="1000000000" MaximumValue="999999999999999" ErrorMessage="Please Insert Minimum 10 and Maximum 15 Digits Required" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender25" runat="server"
                                                        PopupPosition="Right" TargetControlID="RV_EAD_Phone2">
                                                    </ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%;">
                                            ...
                                            <tr id="Tr3" runat="server">
                                                ...
                                                <td id="Td53" style="height: 10px" runat="server" rowspan="2" class="TDClassControl1">
                                                    <asp:TextBox ID="EAD_ADDRESS2" runat="server" CssClass="TextControl" Height="40px"
                                                        MaxLength="50" Style="text-transform: capitalize; min-width: 120px; max-width: 120px;
                                                        min-height: 40px; max-height: 40px" TextMode="MultiLine" ClientIDMode="Static"
                                                        TabIndex="30" Width="120px" onkeypress="maximumLimit(this, 149);"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr id="Tr9" runat="server">
                                                <td id="Td84" class="auto-style1" style="text-align: left;" runat="server">
                                                    Contact No 1:
                                                </td>
                                                <td id="Td85" style="text-align: left;" runat="server" class="auto-style2">
                                                    <asp:TextBox ID="EAD_Phone3" runat="server" onkeypress="return IsNumber(event)" CssClass="TextControl"
                                                        MaxLength="15" Style="text-transform: capitalize;" ClientIDMode="Static" Width="80px"
                                                        TabIndex="34"></asp:TextBox>
                                                    <asp:RangeValidator runat="server" ID="RV_EAD_Phone3" ControlToValidate="EAD_Phone3"
                                                        Display="None" ValidationGroup="validateofficial" Type="Double" SetFocusOnError="true" 
                                                        MinimumValue="1000000000" MaximumValue="999999999999999" ErrorMessage="Please Insert Minimum 10 and Maximum 15 Digits Required" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender26" runat="server"
                                                        PopupPosition="Right" TargetControlID="RV_EAD_Phone3">
                                                    </ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                                <td id="Td86" class="auto-style1" style="text-align: left; padding-left: 15px;"
                                                    runat="server">
                                                    Contact No 2:
                                                </td>
                                                <td id="Td87" runat="server" class="auto-style2">
                                                    <asp:TextBox ID="EAD_Phone4" runat="server" ClientIDMode="Static" CssClass="TextControl"
                                                        MaxLength="15" onkeypress="return IsNumber(event)" Style="text-transform: capitalize;"
                                                        TabIndex="35" Width="80px"></asp:TextBox>
                                                          <asp:RangeValidator runat="server" ID="RV_EAD_Phone4" ControlToValidate="EAD_Phone4"
                                                        Display="None" ValidationGroup="validateofficial" Type="Double" SetFocusOnError="true"
                                                        MinimumValue="1000000000" MaximumValue="999999999999999" ErrorMessage="Please Insert Minimum 10 and Maximum 15 Digits Required" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender27" runat="server"
                                                        PopupPosition="Right" TargetControlID="RV_EAD_Phone4">
                                                    </ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table id="table6" runat="server" width="100%" height="90%" border="0" cellpadding="0"
                                            ...
                                            <tr id="Tr10" runat="server">
                                                ...
                                                maxlength="10" clientidmode="Static" tabindex="40" />--%>
                                                    <asp:TextBox ID="Confdt1" runat="server" ClientIDMode="Static" MaxLength="10" Width="80px"
                                                        onKeyPress="return KeyCheck(event)" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="isValidateDDMMYYYYDate"
                                                        ControlToValidate="Confdt1" Display="None" ErrorMessage="Please Enter Valid Date Or Keep It Blank"
                                            ...
                                            <tr>
                                                ...
                                                <td id="Td73" class="TDClassControl1" style="height: 10px" runat="server">
                                                    <asp:DropDownList ID="ddlcompany" runat="server" ClientIDMode="Static" TabIndex="43" AutoPostBack="true"
