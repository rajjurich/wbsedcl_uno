...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateInput() {
            debugger;
            var emp = document.getElementById("lstEmployees");
            var dt = document.getElementById("txtCalendarFrom");
            var res = document.getElementById("ddlReasonAdd");

            if ((emp.value == "") || (emp.value == null) || (emp.innerHTML == "Select")) {
                emp.focus();
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').style.display = "inline";
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').innerHTML = "Please Select Employee";
            ...
            if (dt.value == "") {
                dt.focus();
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').style.display = "inline";
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').innerHTML = "Please Enter From Date";
            ...
            if (res.value == "Select") {
                res.focus();
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').style.display = "inline";
                document.getElementById('<%=lblErrorSingleEntry.ClientID%>').innerHTML = "Please Select Reason";
        ...
        <ContentTemplate>
                    ...
                    <table style="width: 100%;" border="0">
                        <tr>
                            ...
                            <td style="width: 50%; text-align: right;">
                                ...
                                <asp:TextBox ID="txtSearchEmployeeid" MaxLength="12" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                            ...
                            <asp:Panel ID="pnlgvLeaveData" runat="server" Visible="true">
                                <td style="width: 100%; background-color: #EFF8FE; padding: 0px;" colspan="3">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="gvLeaveData" />
                                            <asp:AsyncPostBackTrigger ControlID="btnSearch" />
                                            <asp:AsyncPostBackTrigger ControlID="lstEmployees" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                            </asp:Panel>
                        ...
                        <table class="TableClass">
                            <tr>
                                    ...
                                    <table class="TableClass" border="0">
                                        ...
                                        <tr>
                                            <td>
                                             ...
                                             <td>   <asp:TextBox ID="txtSearchBox" onkeyup="return SearchList();" runat="server" Height="23px"
                                                ...
                                                <asp:ListBox ID="lstEmployees" runat="server" ClientIDMode="Static" Font-Names="Courier New"
                                                    ...
                                                    AutoPostBack="true" class="chosen-select" 
                                                     onselectedindexchanged="lstEmployees_SelectedIndexChanged"></asp:ListBox>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBoxJoiningDate" runat="server" ClientIDMode="Static" Enabled="false" 
                                ...
                                <td style="height: 10px" colspan="2">
                                        ...
                                        <tr>
                                            <td>
                                               ...
                                               <td> <asp:TextBox ID="txtCalendarFrom" onKeyPress="javascript: return false " runat="server"
                                                    ClientIDMode="Static" CssClass="TextControl" MaxLength="10" Width="35%"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <label class="CompulsaryLabel" style="padding-right: 25px;">
                                                    *</label>
                                              </td><td>  <asp:DropDownList ID="ddlReasonAdd" runat="server" ClientIDMode="Static" class="chosen-select"
                                                    Width="200px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
            ...
            <asp:Panel ID="pnlModify" runat="server" CssClass="PopupPanel">
                    ...
                    <ContentTemplate>
                        <table class="TableClass" border="0">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td align="left">
                                    <asp:Label ID="Label3" runat="server" Text="Joining Date :" Style="vertical-align: top;"></asp:Label>
                                    
                                </td>
                                <td>
                                    <asp:TextBox ID="TextBoxJoiningDateEdit" runat="server" ClientIDMode="Static" Enabled="false" 
                                        CssClass="TextControl" MaxLength="10" Width="35%"></asp:TextBox>
                ...
                <ajaxToolkit:UpdatePanelAnimationExtender ID="UpdatePanelAnimationExtender2" runat="server"
                    TargetControlID="updatepnlEditLeaveData">
                    <Animations>
                        <OnUpdating>
                            <Parallel duration="0">
                                <EnableAction AnimationTarget="btnSearch" Enabled="false" />
