<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Daily_Employee_Report.aspx.cs" Inherits="UNO.Daily_Employee_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function fnCloseReport() {
            alert(lbl);
            var lbl = Master.FindControl("Content1").FindControl("userName");
            alert(lbl);
    ...
    <asp:Panel runat="server" ID="HeadPanel" ClientIDMode="Static" Width="100%">
        <table class="TableClass" cellspacing="1" align="center" width="100%">
                    ...
                    <asp:Panel runat="server" ID="HeadPnl">
                        ...
                        <table class="TableClass" style="width: 100%; height: 75px; margin-left: 4%;">
                            <tr>
                                ...
                                <td style="border: thin solid lightsteelblue; text-align: left; font-weight: bold;display:none"
                                    class="style30">
            ...
            <tr>
                <td align="center" colspan="7" style="vertical-align: middle" class="style37">
