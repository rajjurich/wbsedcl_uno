<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="Access_Settings.aspx.cs" Inherits="UNO.Access_Settings" %>
        ...
        <ContentTemplate>
            <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center" Width="100%">
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                        <asp:Label ID="lblHead" runat="server" Text="Access Settings" ForeColor="RoyalBlue"
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:ListBox ID="lstManager" runat="server" ClientIDMode="Static" Font-Bold="True" class="chosen-select"
                                ...
                                Height="45px" AutoPostBack="True" OnSelectedIndexChanged="lstManager_SelectedIndexChanged">
                            </asp:ListBox>
                        </td>
                    </tr>
                </table>
            ...
            <table class="TableClass" style="width: 70%; height: 75px; margin-left: 15%;">
                <tr>
                    ...
                    <td style="width: 7%; height: 75px; text-align: left; border-right: lightsteelblue thin solid;display:none;
            ...
            <table id="Table4" runat="server" class="tableclass" style="margin-left: 10%; width: 76%;">
                <tr>
                    <td colspan="4" class="TDClassControl" style="text-align: center; padding-right: 44px;">
                        ...
                        <asp:Button ID="btnOK" runat="server" ClientIDMode="Static" class="ButtonControl" OnClientClick="return okclick();"
                            Text="Ok" OnClick="btnOK_Click" style="display:none;" />
                ...
                <tr>
                    <td align="center" colspan="2">
                        ...
                        <asp:Button ID="btnSubmitAdd" runat="server" CssClass="ButtonControl" OnClick="btnSubmitAdd_Click"
                            Text="Save" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnCancelAdd" runat="server" CssClass="ButtonControl" Text="Cancel"  OnClick ="btnCancelAdd_Click"/>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center">
