<%@ Page Language="C#" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Monthly_Biometric_Report.aspx.cs" Inherits="UNO.Monthly_Biometric_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    .TableClass.tblp5 td{ padding:5px;}
    .RB{color:RoyalBlue;}
    </style>
    ...
    <h1 class="heading" style='text-align: center; font-family: Tahoma; font-size: x-large;'>
        <asp:Label ID="lblHeader" runat="server" Text="Check Biometric Report"></asp:Label>
    </h1>
    <div>
        <center>
            <asp:Panel runat="server" ID="HeadPanel" ClientIDMode="Static" Width="90%">
                <table class="TableClass" cellspacing="1" align="center" width="90%">
                                ...
                                <table class="TableClass" style="width: 100%; height: 75px; padding-left: 3%;">
                                    <tr>
                                        ...
                                        <td style="width: 10%; height: 75px; text-align: left; border-right: lightsteelblue thin solid;
                                            border-top: lightsteelblue thin solid; border-left: lightsteelblue thin solid;
                                            border-bottom: lightsteelblue thin solid; font-weight: bold;">
                                            <table id="ForDaily" style="display:none">
                                                <tr>
                                                    <td style="text-align: left">
                                                        Date
                                                    </td>
                                            ...
                                            <table id="ForMonthly" style="display:inline">
                                    <tr><td>Select Month</td></tr>
                                        ...
                                        <td style="border: thin solid lightsteelblue; text-align: left; font-weight: bold;"
                                            class="style25">
                                            <table id="table6" runat="server" style="text-align: right; vertical-align: top">
                                                <tr>
                                                    <td colspan="2" style="height: 26px; text-align: left">
                                                        <asp:CheckBox ID="check_Monthly" runat="server" Text="Check for Monthly"
                                                            Width="125px" />
                                                    </td>
                                                </tr>
                                            </table>
                    ...
                    <tr>
                        <td align="center" colspan="7" style="vertical-align: middle">
                            <asp:Panel ID="Panel1" runat="server" ClientIDMode="Static" Style="display: none">
                                <table style="width: 400px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="height: 7px; vertical-align: bottom; width: 170px;">
                         ...
                         <tr>
            <td colspan="7" class="" style="height: 12px">
                 <asp:Panel runat="server" ID="Panel2">
                 <table class="TableClass tblp5" style="width: 100%; height: 75px; margin-left: 4%;">
                 <tr>
                 <td width="150">
                     <asp:Label ID="lblCompanyName" runat="server" Text="Selected Companies" class="RB" Style="display:none"></asp:Label>
                 <br />
                     <asp:Label ID="lblCompanyList" runat="server" Text="" Style="display:none" ></asp:Label>
                 </td>
                 </tr>
                  <tr>
                 <td>
                     <asp:Label ID="lblProfitCenterName" runat="server" Text="Selected Profit Center" class="RB" Style="display:none"></asp:Label>
                 <br />
                     <asp:Label ID="lblProfitCenter" runat="server" Text="" Style="display:none"></asp:Label>
                 </td>
                 </tr>
                  <tr>
                 <td>
                     <asp:Label ID="lblCostCenterName" runat="server" Text="Selected Cost Center"  class="RB" Style="display:none"></asp:Label>
                 <br />
                     <asp:Label ID="lblCostCenter" runat="server" Text="" Style="display:none"></asp:Label>
                 </td>
                 </tr>
                  <tr>
                 <td>
                     <asp:Label ID="lblGradeName" runat="server" Text="Selected Grade" class="RB" Style="display:none"></asp:Label>
                 <br />
                     <asp:Label ID="lblGrade" runat="server" Text="" Style="display:none"></asp:Label>
                 </td>
                 </tr>
                  <tr>
                 <td>
                     <asp:Label ID="lblEmployeeName" runat="server" Text="Selected Employee" class="RB" Style="display:none"></asp:Label>
                <br />
                     <asp:Label ID="lblEmployee" runat="server" Text="" Style="display:none"></asp:Label>
                 </td>
                 </tr>
                 <tr>
                 <td>
                     <asp:Label ID="lblDesignationName" runat="server" Text="Selected Designation" class="RB" Style="display:none"></asp:Label>
                 <br />
                     <asp:Label ID="lblDesignation" runat="server" Text="" Style="display:none"></asp:Label>
                 </td>
                 </tr>
                 </table>
                 </asp:Panel>
            ...
            <table align="center" style="width: 100%; margin-left: 39px;">
                <tr>
                    ...
                    <td style="text-align: right" class="style28">
                        <div align="center" style="width: 100%;">
                            <asp:Panel ID="viewer" runat="server" Height="410px" BorderStyle="Solid" BorderColor="#0066FF"
                                BorderWidth="3px" Width="90%" Visible="false">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Font-Names="Verdana"
                                    Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                                    WaitMessageFont-Size="14pt" BorderStyle="None" Visible="False" ZoomPercent="80">
                                </rsweb:ReportViewer>
                            </asp:Panel>
