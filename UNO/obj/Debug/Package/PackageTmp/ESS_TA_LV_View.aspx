<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="ESS_TA_LV_View.aspx.cs" Inherits="UNO.ESS_TA_LV_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center" Width="100%">
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                <asp:Label ID="lblHead" runat="server" Text="Leave Application View" ForeColor="RoyalBlue"
    ...
    <center>
                ...
                <tr>
                    <td style="width: 50%; text-align: left;">
                        ...
                        <asp:Button runat="server" ID="btnDelete" Text="Delete" CssClass="ButtonControl"
                            ValidationGroup="Search" OnClick="btnDelete_Click1" />
                             Status          
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvLeave" runat="server" AutoGenerateColumns="false" Width="100%"
                                    ...
                                    <EmptyDataTemplate>
                                        <div>
                                            <span>No Leave Application found.</span>
                                        </div>
                                    </EmptyDataTemplate>
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" SortExpression="Edit" ItemStyle-Width="5%" HeaderStyle-CssClass="center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="False" CommandName="Modify"
                                                    Text="Edit" ForeColor="#3366FF" CommandArgument='<%#Eval("ESS_LA_ROWID")%>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="ESS_LA_ROWID" HeaderText="ID" SortExpression="ID">
                                        ...
                                        <asp:BoundField DataField="ESS_LA_LVCD" HeaderText="Leave Code" SortExpression="LeaveCode">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="ESS_LA_Status" HeaderText="Status" SortExpression="Status">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                         <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowID" runat="server" Text='<%#Eval("ESS_LA_RowID")%>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                    </Columns>
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="gvLeave" />
                <asp:AsyncPostBackTrigger ControlID="btnSearch" />
                ...
                <table style="width:100%" cellpadding="2" cellspacing="2">
                    <tr>
                        <td colspan="4" style="text-align: center">
                            <asp:Label ID="Label24" runat="server" Font-Bold="True" Font-Size="Large" Text="Leave Request"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddleaveType" runat="server" ClientIDMode="Static" CssClass="ComboControl" Width="173px"
                                TabIndex="4">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="ReqddleaveType" runat="server" ControlToValidate="ddleaveType"
                                Display="none" ErrorMessage="Please enter Leave Code" ForeColor="Red" InitialValue="Select One"
                                SetFocusOnError="True" ValidationGroup="Add"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="VCEddleaveType" runat="server" PopupPosition="Right"
                                TargetControlID="ReqddleaveType">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                        <td style="padding-left:3%">
                            Additional Info.
                        ...
                        <td>
                            <asp:TextBox ID="txtRemark" runat="server" CssClass="TextControl" MaxLength="50"  Width="173px"
                                TextMode="MultiLine" style="max-width:173px;min-width:173px;max-height:50px;min-height:50px" onkeyDown="checkLength(this,'50');" onkeyUp="checkLength(this,'50');" onkeypress="checkLength(this,'50');"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td >
                        ...
                        <td>
                            <asp:DropDownList ID="ddlReasonTypeLVReq" runat="server" ClientIDMode="Static" CssClass="ComboControl"  Width="173px"
                                TabIndex="4">
                            </asp:DropDownList>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rbtLeaveType1" runat="server" CssClass="" RepeatDirection="Horizontal">
                                <asp:ListItem Value="F">Fullday</asp:ListItem>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <asp:Button ID="btnSaveLvReq" runat="server" CssClass="ButtonControl" Text="Save"
                                ValidationGroup="Add" OnClick="btnSaveLvReq_Click" />
                            <asp:Button ID="btnCancelLvReq" runat="server" CausesValidation="false" CssClass="ButtonControl"
                                Text="Cancel" OnClick="btnCancelLvReq_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: center;">
    ...
    <ajaxToolkit:ModalPopupExtender ID="mpeAddCall" runat="server" TargetControlID="Button2"
        ...
        CancelControlID="btnCancelLvReq">
