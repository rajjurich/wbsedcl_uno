...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function myFunction() {
            ...
            var textControldesc = document.getElementById("<%=txtControllerDesc.ClientID%>");

            if (textControldesc.value == "") {
                document.getElementById("ddlCtlrType").disabled = true;
            }
            else {
                document.getElementById("ddlCtlrType").disabled = false;
            }
        }

        function myFunction1() {

            var textControldesc = document.getElementById("<%=txtCDesc.ClientID%>");

            if (textControldesc.value == "") {
                document.getElementById("ddlCType").disabled = true;
            }
            else {
                document.getElementById("ddlCType").disabled = false;
            }
        }
        ...
        function validateIP() {
            var ip = document.getElementById('<%=txtCtlrIp.ClientID%>').value;
            var str = ip.split('.');
            if (str[0] == 0) {
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <asp:TextBox ID="txtCtlrID" MaxLength="12" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="gvController" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CTLR_CURRENT_USER_CNT" HeaderText="User Count" ItemStyle-Width="5%"
                                                ...
                                                <asp:BoundField DataField="CTLR_KEY_PAD" HeaderText="Key Pad" ItemStyle-Width="5%"
                                                SortExpression="Key Pad" />
                                                <asp:BoundField DataField="CTLR_LOCATION_ID" HeaderText="Location" ItemStyle-Width="5%"
                                            ...
                                            <asp:TemplateField HeaderText="Empty Reader" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnlReinit1" runat="server" ForeColor="#3366FF" CommandName="Empty"
                                                        CommandArgument='<%#Eval("CTLR_ID")%>' Text="Empty"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <PagerTemplate>
                ...
                <table id="table4" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtControllerId" runat="server" CssClass="TextControl" MaxLength="4"
                            ...
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Please Enter Valid Value"
                                Type="Integer" Display="None" MinimumValue="2" MaximumValue="9999" ControlToValidate="txtControllerId"
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtControllerDesc" runat="server" CssClass="TextControl" MaxLength="50"
                                Width="100%" onkeypress="findQuote(event)" onfocusout="myFunction()" TabIndex="2" ClientIDMode="Static"
                                ValidationGroup="Add"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:CheckBox ID="chkKeypad" runat="server" ClientIDMode="Static" TabIndex="15" />
                        </td>
                    </tr>
                    ...
                    <td style="padding-left: 10px;">
                            <asp:DropDownList ID="ddlLocation" runat="server" ClientIDMode="Static" TabIndex="3"
                                Width="100%"  AutoPostBack="false">
                            </asp:DropDownList>
                           <%-- ValidationGroup="Add"--%>
                            <%--<asp:RequiredFieldValidator ID="rfvLocation" runat="server" ErrorMessage="Please select Location."
                                ControlToValidate="ddlLocation" SetFocusOnError="True" Display="None" InitialValue="Select"
                                ForeColor="Red" ValidationGroup="Add"></asp:RequiredFieldValidator>--%>
                            <%--<ajaxToolkit:ValidatorCalloutExtender ID="vceLocation" runat="server" TargetControlID="rfvLocation"
                                PopupPosition="Right">
                            </ajaxToolkit:ValidatorCalloutExtender>--%>
                        </td>
                    </tr>
                    ...
                    <asp:Panel ID="pnlRdr" runat="server" Visible="false">
                        <table width="100%" border="0" cellpadding="1" cellspacing="1" class="gvHeader">
                            <tr>
                                ...
                                <td style="width: 25%; color: #47A3DA; font-size=20px; font-weight: bolder; background-color: #EFF8FE">
                                    Reader ID
                                </td>
                                <td style="width: 25%; color: #47A3DA; font-size=20px; font-weight: bolder; background-color: #EFF8FE">
                                    Reader Description
                                ...
                                <td style="width: 15%; color: #47A3DA; font-size=20px; font-weight: bolder; background-color: #EFF8FE; visibility:hidden">
                                    Passes From
                                </td>
                                <td style="width: 20%; color: #47A3DA; font-size=20px; font-weight: bolder; background-color: #EFF8FE; visibility:hidden">
                                    Passes To
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView ID="gvReader" runat="server" AutoGenerateColumns="False" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField SortExpression="Reader Description" ItemStyle-Width="25%">
                                                        <ItemTemplate>
            ...
            <ContentTemplate>
                <table id="table1" runat="server" width="100%" height="90%" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:CheckBox ID="chkKeypadEdit" runat="server" ClientIDMode="Static" TabIndex="15" />
                        </td>
                    </tr>
                    <tr runat="server" style="display:none">
                    <td style="text-align: right;">
                    ...
                    <td style="padding-left: 10px;">
                            <asp:DropDownList ID="ddlLocationEdit" runat="server" ClientIDMode="Static" TabIndex="3"
                                Width="100%" AutoPostBack="false">
                            </asp:DropDownList>
                            <%-- ValidationGroup="Edit"
                            <asp:RequiredFieldValidator ID="rfvLocationEdit" runat="server" ErrorMessage="Please select Location."
                                ControlToValidate="ddlLocationEdit" SetFocusOnError="True" Display="None" InitialValue="Select"
                                ForeColor="Red" ValidationGroup="Edit"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="vceLocationEdit" runat="server" TargetControlID="rfvLocationEdit"
                                PopupPosition="Right">
                            </ajaxToolkit:ValidatorCalloutExtender>--%>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            ...
                            <asp:Button ID="btnCancelEdit" runat="server" CssClass="ButtonControl" TabIndex="10"
                                ClientIDMode="Static" Text="Cancel" OnClientClick="HidePanel()" OnClick="btnCancelEdit_Click" CausesValidation="false" />
