...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Reset() {
            debugger;
            document.getElementById("ResetALL_Click").click();
...
//            document.getElementById('<%=lstManager.ClientID%>').selectedIndex = -1; 
            //return false;
        }
    ...
    <table style="width: 100%;">
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="btnReset" runat="server" CssClass="ButtonControl" Text="Reset" 
                     OnClick="ResetALL_Click" />
