...
; (function ($) {
    $.fn.ruler = function (options) {
        ...
        var settings = $.extend({}, defaults, options);
          var element = document.getElementById("droppable");
        ...
        var hRule = '<div class="ruler hRule" style="width:'+w+'cm"></div>',
vRule = '<div class="ruler vRule" style="height:'+h+'cm"></div>',
...
mousePosBox = '<div class="mousePosBox">x: 50%, y: 50%</div>';
        ...
        if (!Modernizr.touch) {
            ...
            if (settings.showCrosshair) {
                $('#Div3').append(vMouse, hMouse);
                 
            }
            // Mouse position
            if (settings.showMousePos) {
                $('#Div3').append(mousePosBox);
