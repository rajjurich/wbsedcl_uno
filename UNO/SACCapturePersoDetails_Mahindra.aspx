...
CodeBehind="SACCapturePersoDetails_Mahindra.aspx.cs" Inherits="UNO.SACCapturePersoDetails_Mahindra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:HiddenField ID="hdConn" runat="server" />
    ...
    <div class="DivEmpDetails" style="width:60%; margin-left:20%;">
                                ...
                                <asp:GridView ID="gvEmpDetails" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                       ...
                                       <%-- HeaderStyle-CssClass="display" ItemStyle-CssClass="display"--%>
                                        ...
                                        <asp:TemplateField HeaderText="Finger Print" ItemStyle-CssClass="hideCol" HeaderStyle-CssClass="hideCol">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Print Card" ItemStyle-CssClass="hideCol" HeaderStyle-CssClass="hideCol">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Personalize Card" ItemStyle-CssClass="hideCol" HeaderStyle-CssClass="hideCol">
                                            <ItemTemplate>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 100%; text-align: center; font-weight: bold; color: Black; font-size: medium; display:none;">
