<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="EmployeeCardConfigView.aspx.cs" Inherits="UNO.EmployeeCardConfigView" %>
 ...
 <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center" Width="100%">
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                <asp:Label ID="lblHead" runat="server" Text="Employee Card Config" ForeColor="RoyalBlue"
       ...
       <table style="width: 100%;">
            <tr>
                ...
                <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="ButtonControl" Style="float: right;" OnClientClick="return ResetAll();" />
                    ...
                    <asp:TextBox ID="textzoneid" runat="server" Style="float: right;" 
                        CssClass="searchTextBox"></asp:TextBox>
                ...
                <td style="width: 100%; background-color: #EFF8FE; padding: 0px;" colspan="3">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvCardConfig" runat="server"  AutoGenerateColumns="false" Width="100%"
                             ...
                             <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Edit" AccessibleHeaderText="Edit" SortExpression="Edit" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName="Modify"  CommandArgument='<%# Eval("cc_emp_id") %>'  ForeColor="#3366FF">Edit</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                       <asp:BoundField DataField="CC_EMP_ID" HeaderText="Employee ID" SortExpression="ID">
                            ...
                            <asp:BoundField DataField="ignore_APB" HeaderText="Ignore APB" SortExpression="Ignore APB">
                                <ItemStyle Width="10%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status">
                                <ItemStyle Width="10%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Activation_date" HeaderText="Activation Date" SortExpression="Activation Date" />
                            <asp:BoundField DataField="Expiry_Date" HeaderText="Expiry Date" SortExpression="Expiry Date" />
                        </Columns>
                                <PagerTemplate>
                                    <table style="width: 100%;">
                                        <tr>
