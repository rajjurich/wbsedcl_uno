<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true" CodeBehind="VEH_VehicleNumbeWiseReport.aspx.cs" Inherits="UNO.VEH_VehicleNumbeWiseReport" %>
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                <asp:Label ID="lblHead" runat="server" Text="Report Based On Vehicle Numbers" ForeColor="RoyalBlue" Font-Size="20px"
...
<tr>
      ...
      <td >
        <%-- <asp:TextBox ID="txtSerch" runat="server" placeholder="Serarch Vehicle Number" style="width:100%;"></asp:TextBox>
           --%> 
              <asp:TextBox ID="TextBox1" ClientIDMode="Static" runat="server" onkeyup="return SearchList();" placeholder="Serarch Vehicle Number" style="width:100%;"></asp:TextBox>
           <br />
            <asp:ListBox ID="LstEmployee" runat="server" ClientIDMode="Static"
            Font-Bold="True" Font-Names="Courier New" ForeColor="Black" Rows="10" 
            SelectionMode="Multiple" Width="250px" Height="92px" ></asp:ListBox>
                ...
                <tr>
                    <td class="TDClassControl">
                        ...
                        <%--<input id="cmdEntityAllRight"  onclick="AllSelectedListBox()"  value="&gt;&gt;"   style="width:28px" type="button"  />--%>
                                  <asp:Button ID="btnMoveAll" runat="server" Text=">>"  
                            style="width:28px" onclick="btnMoveAll_Click" />
                    </td>
                </tr>
                <caption>
                    <tr>
                        <td class="TDClassControl">
                            ...
                            <%--<input id="Button1"  value="&gt;"  onclick="FillEntitySeletedListBox()" style="width:28px" type="button"  />--%>
                                       <asp:Button ID="btnMoveSingle" runat="server" Text=">"  
                                style="width:28px" onclick="btnMoveSingle_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TDClassControl">
                       ...
                       <%--<input id="Button3"  value="&lt;"  onclick="ReturnFillEntityAvailable()"  style="width:28px" type="button"  />--%>
                                       <asp:Button ID="btnReturnSingle" runat="server" Text="<"  
                                style="width:28px" onclick="btnReturnSingle_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TDClassControl">
                            ...
                            <asp:Button ID="btnReturnAll" runat="server" Text="<<"  style="width:28px" 
                                onclick="btnReturnAll_Click" />
                        </td>
                    </tr>
                </caption>
            </table>
        ...
        <td>
         <asp:ListBox ID="LstEntitySelected" runat="server" ClientIDMode="Static" 
        Font-Bold="True" Font-Names="Courier New" ForeColor="Black" Rows="10" 
        SelectionMode="Multiple" Width="250px" Height="113px">
        </asp:ListBox>
...
<%-- <input id="btnOK" class="ButtonControl" style=" margin-left:4%;" name="Ok"   type="button" value="OK" />
 <input id="Button4" class="ButtonControl" style="width:12%;" name="Close"   type="button" value="Close" />--%>
      <asp:Button ID="btnOK"  class="ButtonControl" runat="server" 
          style=" margin-left:8%;" Text="Generate Report" onclick="btnOK_Click" />
