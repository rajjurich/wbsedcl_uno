<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true" CodeBehind="VEH_Controller.aspx.cs" Inherits="UNO.VEH_Controller" %>
...
<asp:TableRow ID="TableRow1" runat="server">
        <asp:TableCell HorizontalAlign="Left" CssClass="CompulsaryLabel">
            <asp:Label ID="lblHead" runat="server" Text="Controller" ForeColor="RoyalBlue"
            ...
            <tr>
                <td style="text-align: left; width: 30%;">
                   <asp:Button ID="btnNew" runat="server" Text="New" 
                        CssClass="ButtonControl" onclick="btnNew_Click" 
                         />
                 
                </td>
                <td style="width: 65%; color: #003300; text-align: center;">
                 <asp:TextBox ID="txtControllerName" runat="server" Style="float: right;text-align:center;" onkeydown = "return (event.keyCode!=13);" CssClass="searchTextBox" Width="162px"></asp:TextBox>
                     <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="txtControllerName"
                        WatermarkText="Search by Controller Description " WatermarkCssClass="watermark">
                    </ajaxToolkit:TextBoxWatermarkExtender>

                     <asp:TextBox ID="txtControllerIDSerch" runat="server" Style="float: right;text-align:center;" onkeydown = "return (event.keyCode!=13);"
                        CssClass="searchTextBox"  Width="162px"></asp:TextBox>
                    <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender5" runat="server" TargetControlID="txtControllerIDSerch"
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtAddControllerIp" Display="None" ValidationGroup="add" ValidationExpression="^(([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))\.){3}([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))$" runat="server" ErrorMessage="Please Enter Valid IP Address"></asp:RegularExpressionValidator>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:Red;font-size:medium;">*</span><asp:TextBox ID="txtAddControllerID"  MaxLength="18" runat="server" ValidationGroup="add"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                            &nbsp;
                                <asp:TextBox ID="txtControllerDescriptionAdd" MaxLength="200" runat="server" Height="43px" Width="262px" 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnCancelAdd" runat="server" CssClass="ButtonControl" 
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtEdiControllerIp" Display="None" ValidationGroup="edit" ValidationExpression="^(([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))\.){3}([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))$" runat="server" ErrorMessage="Please Enter Valid IP Address"></asp:RegularExpressionValidator>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:Red;font-size:medium;">*</span><asp:TextBox ID="txtEditControllerLoc" ValidationGroup="edit" MaxLength="15" runat="server"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:Red;font-size:medium;">*</span><asp:TextBox ID="txtEditControllerID" MaxLength="18" runat="server" ValidationGroup="edit"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                             &nbsp;
                                <asp:TextBox ID="txtEditControllerDescrption" MaxLength="200" runat="server" Height="43px" Width="262px" 
                                    TextMode="MultiLine" style="resize:none"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnUpdateCancel" runat="server" CssClass="ButtonControl" 
                                     Text="Cancel" onclick="btnUpdateCancel_Click" />
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
...
<%--      <asp:Panel ID="pnlEnabled" runat="server" 
    ...
    <ajaxToolkit:ModalPopupExtender ID="mpeNonChekedMsg" runat="server" Enabled="True" BackgroundCssClass="modalBackground"
       ...
       <asp:Panel ID="pnlDeleteController" runat="server" Style="background-color: White; border: 5px solid #000000;
        border-radius: 25px; color: Black;" Width="30%" Height="20%">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnDelete" runat="server" Text="Yes" CssClass="ButtonControl" onclick="btnDelete_Click"
                                 />
                            <asp:Button ID="btnDelCancel" runat="server" Text="No" CssClass="ButtonControl" 
