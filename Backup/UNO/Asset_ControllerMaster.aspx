            ...
            <ContentTemplate>
                <table style="width: 100%" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNewControllerCode" runat="server" MaxLength="5" TabIndex="1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvtxtNewControllerCode" runat="server" ErrorMessage="Please Enter Controller Code"
                                ValidationGroup="Add" ControlToValidate="txtNewControllerCode" Display="None"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNewControllerIP" runat="server" TabIndex="3"></asp:TextBox>
