    ...
    public partial class ControllerView1 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Session["uid"].ToString() == "ADMIN" || Session["uid"].ToString() == "admin")
                {
                    strsql = " Select CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_EVENTS_STORED,CTLR_CURRENT_USER_CNT " +
                             " from ACS_CONTROLLER where CTLR_ISDELETED = 'false' order by CTLR_ID ASC  ";
                    SqlDataAdapter da = new SqlDataAdapter(strsql, conn);
        ...
        protected void btnSubmitAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objcmd.CommandText = " Insert into ACS_CONTROLLER (CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_MAC_ID," +
                                        ...
                                        " CTLR_CHK_APB,CTLR_APB_TYPE,CTLR_APB_TIME,CTLR_AUTHENTICATION_MODE,CTLR_CHK_TOC,CTLR_ISDELETED,CLTR_FOR_TA) " +
                                        ...
                                        " '" + ddlAntipass.SelectedValue + "','" + ddlAPB.SelectedValue + "','" + txtAPBTimed.Text.Trim() + "','" + ddlAuthMode.SelectedValue + "' ,'" + chkAuthMode.Checked + "','false','" + TAADD + "') ";
            ...
            {                
                if (e.CommandName == "Modify")
                {
                    ...
                    strsql = " Select CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_MAC_ID," +
                             ...
                             " CTLR_CHK_APB,CTLR_APB_TYPE,CTLR_APB_TIME,CTLR_AUTHENTICATION_MODE,CTLR_CHK_TOC,CLTR_FOR_TA " +
        ...
        protected void btnSubmitEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objcmd.CommandText = " Update ACS_CONTROLLER set CTLR_IP = '" + txtCIP1.Text.Trim() + "',CTLR_DESCRIPTION = '" + txtCDesc.Text + "',CTLR_MAC_ID = '" + txtCMacId.Text.Trim() + "'," +
                                     ...
                                     " CTLR_AUTHENTICATION_MODE = '" + ddlAuthenticationMode.SelectedValue + "' ,CTLR_CHK_TOC = '" + chkTempOnCard.Checked + "',CLTR_FOR_TA = '" + TA + "' " +
				...
				{"CTLR_DESCRIPTION-" +txtCtlrDesc.Text.Trim(), "S" }			
                    ...
                    if (txtCtlrID.Text.ToString() != "" && txtCtlrDesc.Text.ToString() == "")
                    {
                        strsql1 = " Select CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_EVENTS_STORED,CTLR_CURRENT_USER_CNT " +
                                 " from ACS_CONTROLLER where CTLR_ISDELETED = 'false' AND CTLR_ID Like '%" + txtCtlrID.Text + "%'  order by CTLR_ID ASC";
                    ...
                    {
                        strsql1 = " Select CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_EVENTS_STORED,CTLR_CURRENT_USER_CNT " +
                            " from ACS_CONTROLLER where CTLR_ISDELETED = 'false' AND CTLR_DESCRIPTION Like '%" + txtCtlrDesc.Text + "%' order by CTLR_ID ASC";
                        da1 = new SqlDataAdapter(strsql1, conn);
                        dt1 = new DataTable();
                        da1.SelectCommand.CommandTimeout = 0;
                        da1.Fill(dt1);
                    ...
                    {
                        strsql1 = " Select CTLR_ID,CTLR_DESCRIPTION,CTLR_TYPE,CTLR_IP,CTLR_EVENTS_STORED,CTLR_CURRENT_USER_CNT " +
                           " from ACS_CONTROLLER where CTLR_ISDELETED = 'false' AND CTLR_ID Like '" + txtCtlrID.Text + "%' AND CTLR_DESCRIPTION Like '%" + txtCtlrDesc.Text + "%' order by CTLR_ID ASC ";
                        da1 = new SqlDataAdapter(strsql1, conn);
                        dt1 = new DataTable();
                        da1.SelectCommand.CommandTimeout = 0;
                        da1.Fill(dt1);
