                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 50%; text-align: left;">
                            <asp:Button runat="server" ID="btnAdd" Text="New" CssClass="ButtonControl" OnClick="btnAdd_Click" CausesValidation="false" />
                                    ...
                                    <asp:GridView ID="gvOutpass" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ShowHeader="False" SortExpression="Edit" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandName="Edit1" Text="Edit"  CommandArgument='<%#Eval("OP_RECID") %>' ForeColor="#3366FF"></asp:LinkButton>
                                                </ItemTemplate>
                ...
                <table id="table2" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr id="Empdata" valign="top">
                        ...
                        <td class="TDClassLabel" style="text-align: left" valign="top">
                            ...
                            <asp:TextBox ID="txtEmployeeName" runat="server" ClientIDMode="Static" Enabled="false" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 10px;">
...
" TargetControlID="To_Time" ValidChars=":" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnSave" runat="server" CssClass="ButtonControl" OnClientClick="return handleAdd()"
                                Text="Save" TabIndex="6" Style="float: right" onclick="btnSave_Click" />
                        </td>
                        <td>
    ...
    <ajaxToolkit:ModalPopupExtender ID="mpModifyOutpass" runat="server" TargetControlID="btnModify"
        PopupControlID="Settings" BackgroundCssClass="modalBackground" Enabled="true" CancelControlID="Btnclear">
