            ...
            <ContentTemplate>
                <table class="TableClass" border="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%;">
                            <asp:TextBox runat="server" ID="txtEditMinDaysAllow" Width="75px" MaxLength="4"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%;">
                            <asp:TextBox runat="server" ID="txtEditMaxDaysAllow" Width="75px" MaxLength="4"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtEditLeaveAllotmentAmount" runat="server" ClientIDMode="Static"
                                        Width="75px" MaxLength="6" onkeypress="return Isdigit(event)"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularEditLeaveAllotmentAmount" runat="server"
                                        ...
                                        ErrorMessage="Please enter numeric value" ForeColor="Red" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtEditAccumulation" runat="server" ClientIDMode="Static" Width="75px"
                                        MaxLength="6" onkeypress="return Isdigit(event)"></asp:TextBox>
