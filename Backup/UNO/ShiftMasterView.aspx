...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function get_time_difference(from) {
            ...
            if (val == "Select One") {
                //alert('Please Select the Shift Type'); 
                return false;
            }
            ...
            if (val == "General") {
                ...
                if (ValidateTime(startTime) && ValidateTime(endTime) && ValidateTime(lnchInTime) && ValidateTime(lnchOutTime)) {
                    ...
                    if (LnchStrt > LnchEnd)
                    { alert('Lunch  Start should not be greater than Shift Lunch End '); return false; }
                    if (LnchStrt < start)
                    { alert('Lunch Start should not be greater than Shift Start '); return false; }
                    if (end < LnchEnd)
                    { alert('Lunch End should not be greater than Shift End '); return false; }
            ...
            if (val == "Afternoon") {
                ...
                if (ValidateTime(startTime) && ValidateTime(endTime) && ValidateTime(lnchInTime) && ValidateTime(lnchOutTime)) {
                    ...
                    { alert('Shift Start should not be greater than Shift End'); return false; }
                    if (LnchStrt > LnchEnd)
                    { alert('Lunch Shift Start should not be greater than Shift Lunch End'); return false; }
                    if (LnchStrt < start)
                    { alert('Lunch Start should not be greater than Shift Start Time'); return false; }
                    if (end < LnchEnd)
                    { alert('Lunch End should not be greater than Shift End'); return false; }
                }
                if (from == "N") {
            ...
            if (val == "Night") {
                ...
                { alert('Lunch Start and Lunch End should not be Equal.'); return false; }
                ...
                if (ValidateTime(earlierdate) && ValidateTime(lnchOutTime)) {
                ...
                if (ValidateTime(lnhOut) && ValidateTime(Lnhin) && ValidateTime(earlierdate) && ValidateTime(laterdate)) {


                    if (lnhOut < Lnhin)
                    { alert('Lunch Start should not be greater than Lunch End'); return false; }
                    if (Lnhin < earlierdate)
                    { alert('Lunch Start should not be less than Shift Start'); return false; }
                    if (Lnhin > laterdate)
                    { alert('Lunch Start should not be less than Shift Start'); return false; }
                    if (lnhOut < earlierdate)
                    { alert('Lunch End should not be greater than Shift End'); return false; }
                    if (lnhOut > laterdate)
                    { alert('Lunch End should not be greater than Shift End'); return false; }
