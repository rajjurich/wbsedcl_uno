<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="ODAppView.aspx.cs" Inherits="UNO.ODAppView" %>
    ...
    <asp:Table ID="tblHead" runat="server" HorizontalAlign="Center" Width="100%">
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center" CssClass="CompulsaryLabel">
                <asp:Label ID="lblHead" runat="server" Text="OD Request View" ForeColor="RoyalBlue"
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 50%; text-align: right;">
                        ...
                        <asp:Button runat="server" ID="cmdReset" Text="Reset" CssClass="ButtonControl"
                                ...
                                <asp:GridView ID="gvLVDetails" runat="server" AutoGenerateColumns="false" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" ShowHeader="False" SortExpression="Edit" ItemStyle-HorizontalAlign="Left" >
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblId" runat="server" Text='<%#Eval("Rec_ID")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                      
                                        <asp:BoundField DataField="od_req_employee_id" HeaderText="Employee Code" SortExpression="Employee Code">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="od_req_start_date" HeaderText="From Date" SortExpression="FromDate">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="od_req_end_date" HeaderText="To Date" SortExpression="ToDate">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                    </Columns>
                                    <PagerTemplate>
