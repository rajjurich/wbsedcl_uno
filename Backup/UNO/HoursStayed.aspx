<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.Master" AutoEventWireup="true"
    CodeBehind="HoursStayed.aspx.cs" Inherits="UNO.HoursStayed" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="heading" style='text-align: center; font-family: Tahoma; font-size: x-large;'>
        Hours Stayed In Office Report</h1>
    <%--<asp:UpdatePanel ID="upnListbox" runat="server" UpdateMode="Always">
        <ContentTemplate>--%>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle; height: 28px" colspan="2">
                                                <asp:DropDownList ID="ddlReportType" runat="server" Width="100px">
                                                    ...
                                                    <asp:ListItem Value="1">Working Days</asp:ListItem>
                                                    <asp:ListItem Value="2">Non Working Days</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td colspan="2" style="height: 26px; text-align: left">
                                                <%-- <asp:CheckBox ID="TimeCheckBox" runat="server" onclick="ShowTime(this)" Text="Check for  Timings"
                                                    Width="125px" />--%>
                                                Count more than:
                                                <asp:TextBox ID="txtcount" runat="server" ValidationGroup="Add"></asp:TextBox>
                                                ...
                                                <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server"
                                                    PopupPosition="Right" TargetControlID="rfvCount">
            ...
            <td style="text-align: right" class="style28">
                <div align="center" style="width: 100%;">
                    <asp:Panel ID="viewer" runat="server" Height="410px" BorderStyle="Solid" BorderColor="#0066FF"
                        BorderWidth="3px" Width="80%" Visible="false">
