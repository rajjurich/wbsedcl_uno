...
namespace UNO
{
    public partial class AccessLevelBrowse : System.Web.UI.Page
    {
        ...
        public void fillZoneReadersAdd()
        {
            ...
            try
            {
                string _strsql = "select (Cast(AR.CTLR_ID as varchar) +'-' +  cast(AR.READER_ID as varchar)) as ID, replace(convert(char(17),ltrim(SUBSTRING(AR.READER_DESCRIPTION,1,14)))+ SUBSTRING(AC.CTLR_DESCRIPTION,1,14),' ',' ' ) as DESCRIPTION " +
            ...
            try
            {
                ...
                for (int iR = 0; iR < dtOriginalReader.Rows.Count; iR++)
                {
                    ...
                    if (drCheckReader.Length < 1)
                    {
                        ...
                        strUpdate_EAL_CONFIG += "             SET FLAG='2'";
