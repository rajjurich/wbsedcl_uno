<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/ModuleMain.master"
    CodeBehind="EmployeeCardConfigureADD.aspx.cs" Inherits="UNO.EmployeeCardConfigureADD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function resetAll() {
            ...
            $('#' + ["<%=Exp_Date1.ClientID%>", "<%=Act_Date.ClientID%>", "<%=txtMinimumSwipe.ClientID%>"].join(', #')).prop('value', "");
            return false;
        }
