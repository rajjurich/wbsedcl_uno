<%@ Page Language="C#" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="EmpAndNonEmpStrength.aspx.cs" Inherits="UNO.EmpAndNonEmpStrength" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="heading" style='text-align: center; font-family: Tahoma; font-size: x-large;'>
        <asp:Label ID="lblHeader" runat="server" Text=" Employees Strength Report"></asp:Label>
    </h1>
    <div>
        <center>
