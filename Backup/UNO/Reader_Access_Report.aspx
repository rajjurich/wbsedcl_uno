<%@ Page Language="C#" MasterPageFile="~/ModuleMain.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Reader_Access_Report.aspx.cs" Inherits="MMWebReports.Reader_Access_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function show3() {
            ...
            document.getElementById('LstTitle').innerHTML = "&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reader Code(Controller Code)";
        ...
        function OkClick() {
            ...
            if (document.getElementById('ListBox1').style.display == "inline") {
                ...
                if (first == "")
                    ...
                    DisableControls();
                    //  alert("End Disable ");
                    // alert(document.getElementById('EmployeeHdn').value = first + ")");
                }
            }
            ...
            if (document.getElementById('ListBox2').style.display == "inline") {
                ...
                if (first == "")
                    alert("select atleast one controller");
                else {
                    EnableControls();
            ...
            if (document.getElementById('ListBox3').style.display == "inline") {
                ...
                if (first == "")
                    alert("select atleast one reader");
                else {
                    EnableControls();
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OnShow(action) {
            if (ValidateData()) {
                ...
                var url = "Reader_Access_Report.aspx?" + sBody;
                formName.action = url;
                formName.submit();
            }
        }
        ...
        function HandleAction(formAction, recomputeParentControlName) {
            ...
            httpRequest.open('POST', 'Reader_Access_Report.aspx', true);
        ...
        function ValidationReport() {
            ...
            //     return false
            // }
            // var strFrom = document.getElementById('From_Date').value;
            //  var strTo = document.getElementById('To_Date').value;
    ...
    <h1 class="heading" style='text-align: center; font-family: tahoma; font-size: x-large;'>
        &nbsp;Access Report</h1>
    <asp:Panel runat="server" ID="HeadPanel" ClientIDMode="Static" Width="845px">
                        ...
                        <table class="TableClass" style="width: 40%; height: 75px">
                            <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: left">
                                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" CssClass="radiobutton"
                                                    ...
                                                    <asp:ListItem Value="1" onclick="show2()">Select</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td style="width: 10%; height: 75px; text-align: left; border-right: lightsteelblue thin solid;
                                    border-top: lightsteelblue thin solid; border-left: lightsteelblue thin solid;
                                    border-bottom: lightsteelblue thin solid; font-weight: bold;">
                                    <table style="height: 75px; width: 90px;">
                                        <tr>
                                            <td>
                                                <asp:RadioButtonList ID="RadioButtonList4" runat="server" CssClass="radiobutton"
                                                    RepeatLayout="Flow" ClientIDMode="Static">
                                                    <asp:ListItem Value="0" Selected="True">ReaderWise</asp:ListItem>
                                                    <asp:ListItem Value="1">EmployeeWise</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 10%; display: none; height: 75px; text-align: left; border-right: lightsteelblue thin solid;
                                    border-top: lightsteelblue thin solid; border-left: lightsteelblue thin solid;
                                    border-bottom: lightsteelblue thin solid; font-weight: bold;">
                                    <%--  NEW CALENDER--%>
                                    <table>
                                    ...
                                    <table style="height: 50px">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input type="Button" class="ButtonControl" style="width: 80%;display:none" value="Close" id="Button5"
    ...
    <table align="center" style="width: 71%; margin-left: 39px;">
        ...
        <tr>
            <td style="text-align: right" class="style28">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="921px" Font-Names="Verdana"
