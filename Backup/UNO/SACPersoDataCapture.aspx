      ...
      116, 42, 200, 150, 21, 75, 169, 247, 182, 232, 10, 84, 215, 137, 107, 53];
        ...
        function CardPersonalisation1() {
            ...
            /*    $.ajax({
                ...
                var temp = "";
                for (var a = 0; a < EmployeeCode2.length; a++) {

                    temp = temp + "0" + EmployeeCode2.charAt(a);
                }
                EmployeeCode2 = temp;
                WriteData = "";
                ...
                WriteData = "";
                //                WriteData = ConvertStringToHex(EmployeeCode3) + "00" + "01010101" + "000000";
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvEmpDetails" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Photo" HeaderStyle-CssClass="display" ItemStyle-CssClass="display">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Signature" HeaderStyle-CssClass="display" ItemStyle-CssClass="display">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Print Card">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Personalize Card">
                                            <ItemTemplate>
