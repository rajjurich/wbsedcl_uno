    ...
    <script type="text/javascript">
        function CreateMasterCard() {
            ...
            try {
                ...
                /*CompanyCode*/
                WriteData = CompanyCode + "0000000001010101010101010000";
               WriteData = objReadCard.Convert(WriteData);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <asp:TextBox ID="txtUserID" runat="server" ValidationGroup="Submit" MaxLength="6"></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="FTEtxtUserID" runat="server" FilterType="Numbers"
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <asp:TextBox ID="txtPassword" runat="server" MaxLength="6"></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="FTtxtPassword" runat="server" FilterType="Numbers"
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <asp:TextBox ID="txtMasterkey" runat="server" MaxLength="12" 
                    TextMode="Password"></asp:TextBox>
                      <ajaxToolkit:FilteredTextBoxExtender ID="FTEtxtMasterkey" runat="server" FilterType="Numbers"
                                                            TargetControlID="txtMasterkey"/>
                ...
                <asp:RegularExpressionValidator ID="revtxtMasterkey" runat="server" ErrorMessage="Master Key should be 12 Characters Long."
                    ControlToValidate="txtMasterkey" ValidationGroup="Submit" ValidationExpression="^.{12,12}$"
                    Display="None" Enabled="true"></asp:RegularExpressionValidator>
