                ...
                <tr>
                    ...
                    <td style="width: 50%; text-align: right;">
                        ...
                        <asp:TextBox ID="txtCompanyID" onkeydown="return (event.keyCode!=13);" runat="server"
                            Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                        <asp:DropDownList ID="ddlSearchEnt" runat="server" style="float:right"></asp:DropDownList>
                        &nbsp;&nbsp;&nbsp;&nbsp;<b>Select Code</b>&nbsp;
                ...
                <table id="table4" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td class="TDClassControl" align="right">
                            <asp:TextBox ID="txtID" ClientIDMode="Static" runat="server" MaxLength="8" TabIndex="2"
            ...
            SetFocusOnError="True" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator></td>--%>
                    ...
                    <tr>
                        ...
                        <td class="TDClassControl">
                            <asp:TextBox ID="txtDesc" ClientIDMode="Static" runat="server" TabIndex="3" MaxLength="20"
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                <table id="table1" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="TDClassLabel" align="right">
                            <asp:Label ID="Label1" runat="server" Font-Bold="true" ForeColor="RoyalBlue">Select Master :</asp:Label>
                        </td>
                        <td class="ComboControl" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvddlentityAdd" runat="server" ControlToValidate="ddlEntity"
                                Display="None" ErrorMessage="Please select Master" ForeColor="Red" InitialValue="0"
                                SetFocusOnError="True" Visible="False" ValidationGroup="Modify"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="vcerddlentityedit" runat="server" TargetControlID="rfvddlentityAdd"
                                PopupPosition="Right">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="TDClassControl">
                            <asp:TextBox ID="txtName" ClientIDMode="Static" runat="server" TabIndex="3" MaxLength="20"
                                Style="text-transform: capitalize;" 
