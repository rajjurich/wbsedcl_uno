    ...
    public partial class LeaveADD : System.Web.UI.Page
    {
        ...
        protected void CmdOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdbtnHalf.Checked == true)
                {
                    cmd.Parameters.AddWithValue("@lvDays", "half");
                   
                }
                else {
                    cmd.Parameters.AddWithValue("@lvDays", "Full");
                }
                ...
                cmd.Parameters.AddWithValue("@LeaveCode", ddleaveType.SelectedValue);
                ...
                cmd.ExecuteNonQuery();
                string strMessage = cmd.Parameters["@output"].Value.ToString();
