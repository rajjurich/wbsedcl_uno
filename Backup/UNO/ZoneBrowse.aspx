                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 50%; text-align: right;">
                            ...
                            <asp:TextBox ID="textzoneid" runat="server" Style="float: right;" CssClass="searchTextBox"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:ListBox ID="ModifyLstAREADER" runat="server" Height="90px" Width="280px" ForeColor="Black"
                                            Font-Names="Courier New" CssClass="TextControl" ClientIDMode="Static" SelectionMode="Multiple"
                                            TabIndex="2"></asp:ListBox>
                                    </td>
                                    <td>
