<%@ Page Title="" Language="C#" MasterPageFile="~/ModuleMain.master" AutoEventWireup="true"
    CodeBehind="LateMarkDeduction_Report.aspx.cs" Inherits="UNO.LateMarkDeduction_Report1" %>
...
//                    j++;
    ...
    <div style="width: 100%; text-align: center">
        <br />
        <h1 class="heading" 
            style='text-align: center; font-family: tahoma; font-size: x-large; width: 100%;'>
            Late Mark Deduction Report</h1>
            <br />
            <center>
        <div style="width: 100%; text-align: center;" id="DivSearch" runat="server">
            <table class="TableClass" cellspacing="1" align="center" runat="server" id="ShowTable" style="display: none" width="100%">
                <tr>
                    <td  class="TDClassForButton" style="height: 12px; text-align:center;">
                    <%--    <asp:Panel runat="server" ID="HeadPnl">--%>
                            <table class="TableClass" style="width: 40%; height: 75px;padding-left:26%">
                                <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="View" class="ButtonControl" Style="width: 80%" runat="server" Text="View"
                                                        ClientIDMode="Static" OnClientClick='return ValidationReport()' 
                                                        onclick="View_Click"  />
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table style="width: 400px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <asp:ListBox ID="ListBox4" runat="server" ClientIDMode="Static" Font-Bold="True"
                                            Font-Names="Courier New" Rows="10" SelectionMode="Multiple" Width="100%"></asp:ListBox>
                                          <asp:TextBox ID="txtemp" MaxLength="8"   ClientIDMode="Static" 
                                          onkeypress="return fnCharAlphaNumeric(event)"  
                                ...
                                <td align="center" style="height: 37px; vertical-align: bottom;">
                                      ...
                                      <td align="center" style="height: 37px; vertical-align: bottom; width: 170px;">
                                         <input id="Button1" name="Ok" style="width: 71px" type="button" class="ButtonControl" value="OK" onclick="OkClick()" /> &nbsp;&nbsp;
                                          <input id="Button2" class="ButtonControl" name="Cancel" style="width: 71px" type="button" value="Cancel" onclick="CancelClick()" />
                                      </td>
